// Class: PVZ1ModeAchievementRewardDisplay


/* PVZ1ModeAchievementRewardDisplay::TouchEnded(Sexy::Touch const&) */

void PVZ1ModeAchievementRewardDisplay::TouchEnded(Touch *param_1)

{
  if (*(long *)(param_1 + 0x118) != 0) {
    (**(code **)(*(long *)gLawnApp[0x6c] + 0x68))((long *)gLawnApp[0x6c]);
    (**(code **)(*gLawnApp + 0x150))(gLawnApp,*(undefined8 *)(param_1 + 0x118));
...
/* PVZ1ModeAchievementRewardDisplay::~PVZ1ModeAchievementRewardDisplay() */

void __thiscall
PVZ1ModeAchievementRewardDisplay::~PVZ1ModeAchievementRewardDisplay
          (PVZ1ModeAchievementRewardDisplay *this)

{
  *(undefined ***)this = &PTR_GetClass_069c76b0;
...

{
  ...
  *(undefined4 *)(this + 0xe8) = 0;
  this[0xec] = (PVZ1ModeAchievementRewardDisplay)0x0;
...
/* PVZ1ModeAchievementRewardDisplay::TouchBegan(Sexy::Touch const&) */

void PVZ1ModeAchievementRewardDisplay::TouchBegan(Touch *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* PVZ1ModeAchievementRewardDisplay::SetReawrd(std::vector<S2C_BonusInfo,
   std::allocator<S2C_BonusInfo> > const&) */

void __thiscall
PVZ1ModeAchievementRewardDisplay::SetReawrd(PVZ1ModeAchievementRewardDisplay *this,vector *param_1)

{
  ...
  iVar1 = *(int *)(this + 0x54);
  local_8 = ___stack_chk_guard;
  iVar5 = FUN_04dd93e4(6);
  iVar2 = *(int *)(this + 0x50);
  iVar6 = FUN_04dd93e4(5);
  iVar7 = FUN_04dd93e4(10);
  iVar7 = iVar1 - iVar7;
  ...
  *(undefined8 *)(this + 0x100) = uStack_30;
  ...
  if (cVar4 != '\0') goto LAB_04ddb614;
  uVar12 = *(undefined8 *)param_1;
  uVar8 = FUN_04dd8c00(uVar12,*(undefined8 *)(param_1 + 8));
  if (uVar8 < 2) {
    piVar9 = (int *)FUN_04dd8f7c(uVar12);
    iVar1 = *piVar9;
    uVar3 = piVar9[1];
    if (iVar1 == 0xbc0) {
      uVar12 = CachedUIResourcePtr<Sexy::Image>::operator->
                         ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b9b648);
      *(undefined8 *)(this + 0xd8) = uVar12;
      pwVar11 = L"[REWARD_TYPE_GEM]";
LAB_04ddb680:
      ...
      if (iVar1 == 0xfad) {
        uVar12 = CachedUIResourcePtr<Sexy::Image>::operator->
                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b9b340);
        *(undefined8 *)(this + 0xd8) = uVar12;
        pwVar11 = L"[REWARD_TYPE_COIN]";
        goto LAB_04ddb680;
      }
      GetGameItemInfo(iVar1,0x7fffffff,0);
      if (iStack_34 == 2) {
        this[0xec] = (PVZ1ModeAchievementRewardDisplay)0x1;
      }
      thunk_FUN_05475e00(this + 0xf0,auStack_28);
      lVar10 = StringHelper::ToImage(asStack_18,false);
      if (lVar10 != 0) {
        *(long *)(this + 0xd8) = lVar10;
      }
      thunk_FUN_05477b9c(this + 0x110,auStack_10);
      if ((iVar1 == 0x62fb) && (*(long *)(this + 0xd8) == 0)) {
        uVar12 = CachedUIResourcePtr<Sexy::Image>::operator->
                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b9b740);
        *(undefined8 *)(this + 0xd8) = uVar12;
      }
    ...
    uVar12 = CachedUIResourcePtr<Sexy::Image>::operator->
                       ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b9b2f0);
    *(undefined8 *)(this + 0xd8) = uVar12;
    TodStringTranslate(L"[LEGEND_LOGIN_CHEST]");
    FUN_054766c8(this + 0x110,(Insets *)&local_38);
    FUN_05476c50((Insets *)&local_38);
    uVar8 = 1;
  }
  Sexy::StrFormat("x%d",asStack_40,uVar8);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* PVZ1ModeAchievementRewardDisplay::Draw(Sexy::Graphics*) */

void __thiscall
PVZ1ModeAchievementRewardDisplay::Draw(PVZ1ModeAchievementRewardDisplay *this,Graphics *param_1)

{
  ...
  local_8 = ___stack_chk_guard;
  if (this[0xec] != (PVZ1ModeAchievementRewardDisplay)0x0) {
