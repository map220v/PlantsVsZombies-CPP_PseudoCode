// Class: ZombiePerfumerChallenge


/* ZombiePerfumerChallenge::gameplayEnded() */

void __thiscall ZombiePerfumerChallenge::gameplayEnded(ZombiePerfumerChallenge *this)
...
void ZombiePerfumerChallenge::StaticClassInit(void)

{
  ...
  if ((this != (CRefSymbolDb *)0x0) &&
    ...
    std::string::string(asStack_10,"ZombiePerfumerChallenge");
    (*pcVar2)(plVar1,asStack_10,FUN_036849a0,0x30,0);
...
/* ZombiePerfumerChallenge::StaticGetClass() */

long * ZombiePerfumerChallenge::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"ZombiePerfumerChallenge",uVar2,StaticNew);
  StaticClassInit();
  return sClass;
}


/* ZombiePerfumerChallenge::~ZombiePerfumerChallenge() */

void __thiscall ZombiePerfumerChallenge::~ZombiePerfumerChallenge(ZombiePerfumerChallenge *this)

{
  *(undefined ***)this = &PTR_GetModuleClass_0667ada0;
...
/* ZombiePerfumerChallenge::StaticNew() */

ZombiePerfumerChallenge * ZombiePerfumerChallenge::StaticNew(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombiePerfumerChallenge::gameplayStarted() */

void __thiscall ZombiePerfumerChallenge::gameplayStarted(ZombiePerfumerChallenge *this)

{
  ...
  CachedUIResourcePtr::operator_cast_to_RtWeakPtr((CachedUIResourcePtr *)&DAT_06aab188);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombiePerfumerChallenge::onNotifyCleanPoison() */

void __thiscall ZombiePerfumerChallenge::onNotifyCleanPoison(ZombiePerfumerChallenge *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombiePerfumerChallenge::registerForEvents() */

void __thiscall ZombiePerfumerChallenge::registerForEvents(ZombiePerfumerChallenge *this)

{
  ...
  Sexy::
  MakeDelegate<Sexy::AndroidHttpTransaction::ReceivedDataCallback,void(Sexy::AndroidHttpTransaction::ReceivedDataCallback::*)()>
            ((ReceivedDataCallback *)this,onNotifyCleanPoison);
  Sexy::Delegate0::Delegate0<ZombiePerfumerChallenge,void(ZombiePerfumerChallenge::*)()>
            (aDStack_38,aCStack_50);
  MessageRouter::Subscribe((MessageRouter *)puVar1,Message::NotifyCleanPoison,aDStack_38);
  if (local_8 == ___stack_chk_guard) {
    return;
  }
                    /* WARNING: Subroutine does not return */
