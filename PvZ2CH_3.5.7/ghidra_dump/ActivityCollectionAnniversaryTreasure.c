// Class: ActivityCollectionAnniversaryTreasure


/* ActivityCollectionAnniversaryTreasure::ActivityCollectionAnniversaryTreasure() */

void __thiscall
ActivityCollectionAnniversaryTreasure::ActivityCollectionAnniversaryTreasure
          (ActivityCollectionAnniversaryTreasure *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662b0d0;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662b438;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662b480;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionAnniversaryTreasure_0662b4a0;
  return;
}
...
{
  ~ActivityCollectionAnniversaryTreasure(this + -0xe8);
  return;
}
...
/* ActivityCollectionAnniversaryTreasure::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionAnniversaryTreasure::InitContainer
          (ActivityCollectionAnniversaryTreasure *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a3a);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_ANNIVERSARYTREASURE");
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionAnniversaryTreasure::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionAnniversaryTreasure::Draw
          (ActivityCollectionAnniversaryTreasure *this,Graphics *param_1)

{
  ...
  pIVar8 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa0358);
  ...
  TodStringTranslate(L"[ANNIVERSART_TREASURE_SHORT_DESCRIPTION]");
