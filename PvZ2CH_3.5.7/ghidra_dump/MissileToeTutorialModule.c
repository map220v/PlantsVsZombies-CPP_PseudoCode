// Class: MissileToeTutorialModule


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* MissileToeTutorialModule::onMissileToeTappedWhileCoolingDown() */

void __thiscall
MissileToeTutorialModule::onMissileToeTappedWhileCoolingDown(MissileToeTutorialModule *this)

{
  ...
  if (this[0x4c] == (MissileToeTutorialModule)0x0) {
    pBVar1 = *(Board **)(gLawnApp + 0x9f0);
    FUN_05478178(auStack_10,L"[ADVICE_MISSILETOE_TUTORIAL_COOLDOWN]",auStack_18);
...
void MissileToeTutorialModule::StaticClassInit(void)

{
  ...
  if ((this != (CRefSymbolDb *)0x0) &&
    ...
    std::string::string(asStack_10,"MissileToeTutorialModule");
    (*pcVar2)(plVar1,asStack_10,FUN_03bf71a4,0x68,0);
...
/* MissileToeTutorialModule::StaticGetClass() */

long * MissileToeTutorialModule::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"MissileToeTutorialModule",uVar2,StaticNew);
  StaticClassInit();
  return sClass;
}


/* MissileToeTutorialModule::MissileToeTutorialModule() */

void __thiscall MissileToeTutorialModule::MissileToeTutorialModule(MissileToeTutorialModule *this)

{
  StandardLevelIntro::StandardLevelIntro((StandardLevelIntro *)this);
  *(undefined ***)this = &PTR_GetModuleClass_067415a0;
...
/* MissileToeTutorialModule::StaticNew() */

MissileToeTutorialModule * MissileToeTutorialModule::StaticNew(void)

{
  MissileToeTutorialModule *this;
...
/* MissileToeTutorialModule::onMissileToeLaunched() */

void __thiscall MissileToeTutorialModule::onMissileToeLaunched(MissileToeTutorialModule *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* MissileToeTutorialModule::pointArrowAtMissileToe() */

void __thiscall MissileToeTutorialModule::pointArrowAtMissileToe(MissileToeTutorialModule *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* MissileToeTutorialModule::onMissileToeSelected() */

void __thiscall MissileToeTutorialModule::onMissileToeSelected(MissileToeTutorialModule *this)

{
  ...
  if (this[0x4c] != (MissileToeTutorialModule)0x0) {
    Board::ClearAdviceImmediately(*(Board **)(gLawnApp + 0x9f0));
    pBVar1 = *(Board **)(gLawnApp + 0x9f0);
    FUN_05478178(auStack_10,L"[ADVICE_MISSILETOE_TUTORIAL_SHOOT]",auStack_18);
...
/* MissileToeTutorialModule::onTutorialFinished() */

void __thiscall MissileToeTutorialModule::onTutorialFinished(MissileToeTutorialModule *this)

{
  char cVar1;
  long extraout_x0;
  
  this[0x4c] = (MissileToeTutorialModule)0x0;
  ...
  if (cVar1 != '\0') {
    ...
    nop();
    FUN_03bf25f0(extraout_x0 + 0x29,0);
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* MissileToeTutorialModule::registerForEvents() */

void __thiscall MissileToeTutorialModule::registerForEvents(MissileToeTutorialModule *this)

{
  ...
  MakeDelegate<Sexy::AndroidHttpTransaction::ReceivedDataCallback,void(Sexy::AndroidHttpTransaction::ReceivedDataCallback::*)()>
            ((ReceivedDataCallback *)this,onMissileToeSelected);
  Sexy::Delegate0::Delegate0<MissileToeTutorialModule,void(MissileToeTutorialModule::*)()>
            (aDStack_38,(CBMemberTranslatorX *)&local_50);
  MessageRouter::Subscribe((MessageRouter *)puVar1,Message::MissileToeSelected,aDStack_38);
  puVar1 = gMessageRouter;
  Sexy::
  MakeDelegate<Sexy::AndroidHttpTransaction::ReceivedDataCallback,void(Sexy::AndroidHttpTransaction::ReceivedDataCallback::*)()>
            ((ReceivedDataCallback *)this,onMissileToeLaunched);
  Sexy::Delegate0::Delegate0<MissileToeTutorialModule,void(MissileToeTutorialModule::*)()>
            (aDStack_38,(CBMemberTranslatorX *)&local_50);
  MessageRouter::Subscribe((MessageRouter *)puVar1,Message::MissileToeLaunched,aDStack_38);
  puVar1 = gMessageRouter;
  Sexy::
  MakeDelegate<Sexy::AndroidHttpTransaction::ReceivedDataCallback,void(Sexy::AndroidHttpTransaction::ReceivedDataCallback::*)()>
  ...
  local_80 = local_40;
  MessageRouter::
  Subscribe<Zombie*,DamageInfo_const*,Sexy::CBMemberTranslatorX<MissileToeTutorialModule,void(MissileToeTutorialModule::*)(Zombie*,DamageInfo_const*)>>
            ((MessageRouter *)puVar1,Message::ZombieDied,&local_90);
  puVar1 = gMessageRouter;
  Sexy::
  MakeDelegate<Sexy::AndroidHttpTransaction::ReceivedDataCallback,void(Sexy::AndroidHttpTransaction::ReceivedDataCallback::*)()>
            ((ReceivedDataCallback *)this,onMissileToeTappedWhileCoolingDown);
  Sexy::Delegate0::Delegate0<MissileToeTutorialModule,void(MissileToeTutorialModule::*)()>
            (aDStack_38,aCStack_68);
  MessageRouter::Subscribe((MessageRouter *)puVar1,Message::MissileToeTappedOnCooldown,aDStack_38);
  if (local_8 == ___stack_chk_guard) {
    return;
  }
                    /* WARNING: Subroutine does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* MissileToeTutorialModule::onZombieDestroyed(Zombie*, DamageInfo const*) */

void MissileToeTutorialModule::onZombieDestroyed(Zombie *param_1,DamageInfo *param_2)

{
  ...
  if (param_2 == pDVar1) {
    ...
    nop();
    FUN_03bf25e8(extraout_x0 + 0x28,0);
    Board::ClearAdviceImmediately(*(Board **)(gLawnApp + 0x9f0));
    this_00 = (AnimationMgr *)
              Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get
                        ((RtWeakPtr<Sexy::ResourceInfo> *)(*(long *)(gLawnApp + 0x9f0) + 0x898));
    fVar4 = (float)FUN_03bf254c(*(undefined4 *)(this_00 + 0x10));
    FUN_05478178(asStack_10,L"[ADVICE_MISSILETOE_TUTORIAL_GOOD_JOB]",aRStack_18);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* MissileToeTutorialModule::startLevelIntro(StandardLevelIntro::PanType, bool) */

void MissileToeTutorialModule::startLevelIntro(LevelModule *param_1,undefined4 param_2)

{
  ...
  if (cVar1 == '\0') {
    ...
    std::string::string((string *)local_18,"missiletoe");
  ...
  if (cVar1 == '\0') {
    ...
    nop();
    FUN_03bf25e8(extraout_x0 + 0x28,1);
    Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get((RtWeakPtr<Sexy::ResourceInfo> *)this);
    nop();
    FUN_03bf25f0(extraout_x0_00 + 0x29,1);
    ...
    this_03 = (AnimationMgr *)
              Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get
                        ((RtWeakPtr<Sexy::ResourceInfo> *)(*(long *)(gLawnApp + 0x9f0) + 0x898));
    fVar13 = (float)FUN_03bf254c(*(undefined4 *)(this_03 + 0x10));
    ...
    std::string::~string((string *)local_18);
    nop();
    FUN_05478178((RtWeakPtr<Sexy::ResourceInfo> *)local_18,L"[ADVICE_MISSILETOE_TUTORIAL_SELECT]",
                 asStack_20);
    ...
    std::string::string((string *)local_18,"pointArrowAtMissileToe");
