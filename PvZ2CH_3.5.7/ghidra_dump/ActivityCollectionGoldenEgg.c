// Class: ActivityCollectionGoldenEgg


/* ActivityCollectionGoldenEgg::ActivityCollectionGoldenEgg() */

void __thiscall
ActivityCollectionGoldenEgg::ActivityCollectionGoldenEgg(ActivityCollectionGoldenEgg *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662a050;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662a3b8;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662a400;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionGoldenEgg_0662a420;
  return;
}
...
/* non-virtual thunk to ActivityCollectionGoldenEgg::~ActivityCollectionGoldenEgg() */

void __thiscall
ActivityCollectionGoldenEgg::~ActivityCollectionGoldenEgg(ActivityCollectionGoldenEgg *this)

{
  ~ActivityCollectionGoldenEgg(this + -0xe8);
  return;
}
...
{
  ~ActivityCollectionGoldenEgg(this);
  AK::FreeHook(this);
  return;
}
...
/* ActivityCollectionGoldenEgg::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionGoldenEgg::InitContainer
          (ActivityCollectionGoldenEgg *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a59);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_GOLDENEGG");
...
/* non-virtual thunk to ActivityCollectionGoldenEgg::InitContainer(ActivityCollectionTabBase*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionGoldenEgg::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionGoldenEgg::Draw(ActivityCollectionGoldenEgg *this,Graphics *param_1)
