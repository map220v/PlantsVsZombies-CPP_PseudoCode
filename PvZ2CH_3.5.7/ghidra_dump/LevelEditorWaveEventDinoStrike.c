// Class: LevelEditorWaveEventDinoStrike


/* LevelEditorWaveEventDinoStrike::~LevelEditorWaveEventDinoStrike() */

void __thiscall
LevelEditorWaveEventDinoStrike::~LevelEditorWaveEventDinoStrike
          (LevelEditorWaveEventDinoStrike *this)

{
  *(undefined ***)this = &PTR_GetClass_06969a80;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_06969da8;
...
void __thiscall
LevelEditorWaveEventDinoStrike::LevelEditorWaveEventDinoStrike(LevelEditorWaveEventDinoStrike *this)
...
/* LevelEditorWaveEventDinoStrike::ButtonDepress(int) */

void __thiscall
LevelEditorWaveEventDinoStrike::ButtonDepress(LevelEditorWaveEventDinoStrike *this,int param_1)

{
  ...
  switch(param_1) {
  case 0x7e6:
    uVar1 = ClampInt(*(int *)(this + 0x104) + -1,1,5);
    *(undefined4 *)(this + 0x104) = uVar1;
    pCVar3 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
    CustomLevelMgr::SetDinoRow(pCVar3,*(int *)(this + 0x100),*(int *)(this + 0x104));
    return;
  case 0x7e7:
    uVar1 = ClampInt(*(int *)(this + 0x104) + 1,1,5);
    *(undefined4 *)(this + 0x104) = uVar1;
  ...
  uVar1 = ClampInt(iVar2,1,3);
  *(undefined4 *)(this + 0x108) = uVar1;
  pCVar3 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
  CustomLevelMgr::SetDinoTimeInterval(pCVar3,*(int *)(this + 0x100),(float)*(int *)(this + 0x108));
  return;
}


/* non-virtual thunk to LevelEditorWaveEventDinoStrike::ButtonDepress(int) */
...
/* LevelEditorWaveEventDinoStrike::Reload() */

void __thiscall LevelEditorWaveEventDinoStrike::Reload(LevelEditorWaveEventDinoStrike *this)

{
  ...
  iVar2 = CustomLevelMgr::GetDinoRow(pCVar1,*(int *)(this + 0x100));
  uVar3 = ClampInt(iVar2,1,5);
  *(undefined4 *)(this + 0x104) = uVar3;
  pCVar1 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
  CustomLevelMgr::SetDinoRow(pCVar1,*(int *)(this + 0x100),*(int *)(this + 0x104));
  pCVar1 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
  fVar4 = (float)CustomLevelMgr::GetDinoTimeInterval(pCVar1,*(int *)(this + 0x100));
  uVar3 = ClampInt((int)fVar4,1,3);
  *(undefined4 *)(this + 0x108) = uVar3;
  pCVar1 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
  CustomLevelMgr::SetDinoTimeInterval(pCVar1,*(int *)(this + 0x100),(float)*(int *)(this + 0x108));
  return;
}


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LevelEditorWaveEventDinoStrike::Init(int) */

void __thiscall
LevelEditorWaveEventDinoStrike::Init(LevelEditorWaveEventDinoStrike *this,int param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LevelEditorWaveEventDinoStrike::Draw(Sexy::Graphics*) */

void __thiscall
LevelEditorWaveEventDinoStrike::Draw(LevelEditorWaveEventDinoStrike *this,Graphics *param_1)

{
  ...
  TodStringTranslate(L"[LEVEL_EDITOR_WAVE_EVENT_DINO_STRIKE_TITLE]");
  ...
  WriteWordInRect(param_1,auStack_30,aIStack_18,uVar2,aIStack_28,5,1);
  FUN_05476c50(auStack_30);
  pIVar3 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b86410);
  Sexy::Graphics::DrawImage
            (param_1,pIVar3,*(int *)(this + 300),*(int *)(this + 0x130),*(int *)(this + 0x134),
             *(int *)(this + 0x138));
  pIVar3 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b86410);
  Sexy::Graphics::DrawImage
            (param_1,pIVar3,*(int *)(this + 0x15c),*(int *)(this + 0x160),*(int *)(this + 0x164),
             *(int *)(this + 0x168));
  TodStringTranslate(L"[LEVEL_EDITOR_WAVE_EVENT_DINO_STRIKE_BTN_LEFT]");
  Sexy::Insets::Insets
  ...
  TodStringTranslate(L"[LEVEL_EDITOR_WAVE_EVENT_DINO_STRIKE_BTN_RIGHT]");
  Sexy::Insets::Insets
