// Class: CartInstanceTableInserter


/* CartInstanceTableInserter::~CartInstanceTableInserter() */

void __thiscall
CartInstanceTableInserter::~CartInstanceTableInserter(CartInstanceTableInserter *this)

{
  *(undefined ***)this = &PTR__CartInstanceTableInserter_06792670;
...
{
  ~CartInstanceTableInserter(this);
  AK::FreeHook(this);
  return;
}
...
/* CartInstanceTableInserter::CartInstanceTableInserter(Sexy::MetricsManager*, std::string const&,
   std::string const&, std::string const&) */

void __thiscall
CartInstanceTableInserter::CartInstanceTableInserter
          (CartInstanceTableInserter *this,MetricsManager *param_1,string *param_2,string *param_3,
          string *param_4)

{
  ...
  std::string::string(asStack_18,"CartInstance");
  ...
  nop();
  ppuVar6 = &PTR__CartInstanceTableInserter_06792670;
  *(undefined ***)this = &PTR__CartInstanceTableInserter_06792670;
