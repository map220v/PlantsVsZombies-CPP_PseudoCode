// Class: ActivityCollectionUINewYearGiftBox


/* ActivityCollectionUINewYearGiftBox::ActivityCollectionUINewYearGiftBox() */

void __thiscall
ActivityCollectionUINewYearGiftBox::ActivityCollectionUINewYearGiftBox
          (ActivityCollectionUINewYearGiftBox *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662fe40;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_066301a8;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_066301f0;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionUINewYearGiftBox_06630210;
  return;
}
...
/* non-virtual thunk to ActivityCollectionUINewYearGiftBox::~ActivityCollectionUINewYearGiftBox() */
...
{
  ~ActivityCollectionUINewYearGiftBox(this + -0xe8);
  return;
}
...
/* ActivityCollectionUINewYearGiftBox::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionUINewYearGiftBox::InitContainer
          (ActivityCollectionUINewYearGiftBox *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a80);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_NEWYEARGIFTBOX");
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionUINewYearGiftBox::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionUINewYearGiftBox::Draw(ActivityCollectionUINewYearGiftBox *this,Graphics *param_1)

{
  ...
  pIVar8 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa0160);
