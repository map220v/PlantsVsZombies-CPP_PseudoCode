// Class: DVisibleCreator


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* DVisibleCreator::create() */

void DVisibleCreator::create(void)

{
  DRef *this;
  undefined8 uVar1;
  DRefPtr<DVisible> aDStack_10 [8];
  long local_8;
  
  local_8 = ___stack_chk_guard;
  DRefPtr<DVisible>::DRefPtr(aDStack_10);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* DVisibleCreator::DVisibleCreator() */

void __thiscall DVisibleCreator::DVisibleCreator(DVisibleCreator *this)

{
  ...
  *(undefined ***)this = &PTR_nop_06a261b0;
  this_00 = (DNodeLoader *)DSingleton<DNodeLoader>::getInstance();
  std::string::string(asStack_10,"DVisible");
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* DVisibleCreator::loadConfig(DAction*, DIniField*, std::string const&, DNodeLoaderConfig*) */

void DVisibleCreator::loadConfig
...

{
  ...
  if (param_2 != (DIniField *)0x0) {
    std::string::string(asStack_30,"show");
