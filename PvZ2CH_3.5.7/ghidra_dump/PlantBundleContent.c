// Class: PlantBundleContent


/* PlantBundleContent::~PlantBundleContent() */

void __thiscall PlantBundleContent::~PlantBundleContent(PlantBundleContent *this)

{
  *(undefined ***)this = &PTR_GetClass_06983490;
...
{
  ~PlantBundleContent(this);
  AK::FreeHook(this);
  return;
}


/* PlantBundleContent::PlantBundleContent(PlantBundleData const&) */

void __thiscall
PlantBundleContent::PlantBundleContent(PlantBundleContent *this,PlantBundleData *param_1)
...
/* PlantBundleContent::Draw(Sexy::Graphics*) */

void __thiscall PlantBundleContent::Draw(PlantBundleContent *this,Graphics *param_1)

{
  ...
  if (cVar2 != '\0') {
    ...
    iVar4 = FUN_04c25064(0x28);
    iVar20 = FUN_04c25064(0x29);
    iVar6 = FUN_04c25064(0x2d);
    ...
    if (bVar3) {
      ...
      if (cVar2 != '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          pLVar14 = (LotteryResultProgressBar *)
                    CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b8f0f8);
          iVar6 = LotteryResultProgressBar::GetCurrentLevel(pLVar14);
          iVar20 = *(int *)(this + 0x54);
          ...
          ;
          iVar4 = FUN_04c25064(0x28);
          iVar6 = FUN_04c25064(0x29);
          iVar7 = FUN_04c25064(0x2d);
          FUN_05477b24(aCStack_50,auStack_58);
          Sexy::Color::Color(aCStack_40,1);
          Sexy::PrimeTypeface::DrawString_Line
...
LAB_04c268b8:
  ...
  if (cVar2 != '\0') {
    ...
    if (bVar3) {
      ...
      if (cVar2 != '\0') {
        ...
        pLVar14 = (LotteryResultProgressBar *)
                  CachedUIResourcePtr<Sexy::Image>::operator->
                            ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b8ef00);
        iVar6 = LotteryResultProgressBar::GetCurrentLevel(pLVar14);
        iVar20 = *(int *)(this + 0x54);
        pSVar15 = (SalesProgressBar *)
                  CachedUIResourcePtr<Sexy::Image>::operator->
        ...
        if (pIVar13 != (Image *)0x0) {
          iVar19 = (int)(((float)iVar4 - (float)iVar6 * 0.8) * 0.5);
          iVar7 = (int)(((float)iVar20 - (float)iVar7 * 0.8) * 0.5);
          Sexy::Graphics::DrawImage
                    (param_1,pIVar13,iVar19,iVar7,(int)((float)iVar5 * 0.8),
                     (int)((float)iVar8 * 0.8));
          Sexy::StrFormat(L"x%d",auStack_58,(ulong)uVar1);
          uVar18 = PrimeText_PotentialTypeface::Typeface(PrimeText_Game::Typeface_CafeteriaBlack_20)
          ;
  ...
  cVar2 = FUN_04c24ba8(iVar4);
  if (cVar2 == '\0') {
    OtherServerNameMapper::GetInstance();
    cVar2 = FUN_04c24b98(iVar4);
    if (cVar2 == '\0') {
      OtherServerNameMapper::GetInstance();
      cVar2 = FUN_04c24bb8(iVar4);
      if (cVar2 == '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          if (pLVar14 != (LotteryResultProgressBar *)0x0) {
            ...
            case 0:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b8f270);
              break;
            case 1:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b8f170);
            ...
            case 2:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b8f1f8);
              break;
            case 3:
            case 4:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b8ee88);
              break;
            default:
              pIVar13 = (Image *)0x0;
            }
      ...
      if (cVar2 != '\0') {
        ...
        Sexy::StrFormat(L"x%d",auStack_58,(ulong)uVar1);
        uVar18 = PrimeText_PotentialTypeface::Typeface(PrimeText_Game::Typeface_CafeteriaBlack_20);
        iVar4 = FUN_04c25064(0xc);
        iVar20 = FUN_04c25064(0x22);
        iVar6 = FUN_04c25064(0x2d);
        FUN_05477b24(aCStack_50,auStack_58);
        Sexy::Color::Color(aCStack_40,1);
        iVar4 = iVar4 + iVar5;
