// Class: NewPVPBattlePassLotteryPanel


/* NewPVPBattlePassLotteryPanel::InitSteps() */

void __thiscall NewPVPBattlePassLotteryPanel::InitSteps(NewPVPBattlePassLotteryPanel *this)

{
  ...
  *(undefined4 *)(this + 0x17c) = 0;
  iVar3 = FUN_03539a94(*(undefined8 *)(this + 0x140),*(undefined8 *)(this + 0x148));
...
/* NewPVPBattlePassLotteryPanel::StartLottery(int) */

void __thiscall
NewPVPBattlePassLotteryPanel::StartLottery(NewPVPBattlePassLotteryPanel *this,int param_1)

{
  ...
  *(undefined4 *)(this + 0x1c0) = 1;
  this[0x131] = (NewPVPBattlePassLotteryPanel)0x0;
  *(undefined4 *)(this + 0x178) = 0x40400000;
  return;
}


/* NewPVPBattlePassLotteryPanel::AlmostThere() */

bool __thiscall NewPVPBattlePassLotteryPanel::AlmostThere(NewPVPBattlePassLotteryPanel *this)

{
  int iVar1;
  int iVar2;
  
  iVar2 = FUN_03539a94(*(undefined8 *)(this + 0x140),*(undefined8 *)(this + 0x148));
  iVar1 = iVar2 + 3;
  if (-1 < iVar2) {
    iVar1 = iVar2;
  }
...
/* NewPVPBattlePassLotteryPanel::LotteryEffect() */

void __thiscall NewPVPBattlePassLotteryPanel::LotteryEffect(NewPVPBattlePassLotteryPanel *this)

{
  ...
  this[0x131] = (NewPVPBattlePassLotteryPanel)0x1;
  ...
  if (cVar1 != '\0') {
    ...
    Delegate1<NewPVPBattlePassLotteryPanel,void(NewPVPBattlePassLotteryPanel::*)(std::string_const&)>
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::DrawAll(Sexy::ModalFlags*, Sexy::Graphics*) */

void __thiscall
NewPVPBattlePassLotteryPanel::DrawAll
          (NewPVPBattlePassLotteryPanel *this,ModalFlags *param_1,Graphics *param_2)

{
  ...
  uVar4 = FUN_03539a94(*(undefined8 *)(this + 0x140),*(undefined8 *)(this + 0x148));
  if (uVar4 != 0) {
    do {
      if (*(int *)(this + 0x174) == (int)uVar7) {
        ...
        pIVar6 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                    ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa5a50);
        iVar1 = local_18;
...
/* NewPVPBattlePassLotteryPanel::NewPVPBattlePassLotteryPanel() */

void __thiscall
NewPVPBattlePassLotteryPanel::NewPVPBattlePassLotteryPanel(NewPVPBattlePassLotteryPanel *this)

{
  UISingletonDialog<NewPVPBattlePassLotteryPanel>::UISingletonDialog
            ((UISingletonDialog<NewPVPBattlePassLotteryPanel> *)this);
  *(undefined8 *)(this + 0x138) = 0;
  *(undefined ***)this = &PTR_GetClass_06655fb0;
  *(undefined **)(this + 0xd8) = &DAT_06656300;
...

{
  ...
  *(undefined **)(this + 0xd8) = &DAT_06656300;
  ...
  std::vector<NewPVPBattlePassAward,std::allocator<NewPVPBattlePassAward>>::~vector
            ((vector<NewPVPBattlePassAward,std::allocator<NewPVPBattlePassAward>> *)(this + 0x140));
  UISingletonDialog<NewPVPBattlePassLotteryPanel>::~UISingletonDialog
            ((UISingletonDialog<NewPVPBattlePassLotteryPanel> *)this);
  return;
}
...
{
  ~NewPVPBattlePassLotteryPanel(this);
  AK::FreeHook(this);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::SelectNext() */

void __thiscall NewPVPBattlePassLotteryPanel::SelectNext(NewPVPBattlePassLotteryPanel *this)

{
  ...
  local_8 = ___stack_chk_guard;
  uVar3 = FUN_03539a94(*(undefined8 *)(this + 0x140),*(undefined8 *)(this + 0x148));
  iVar1 = 0;
  if (uVar3 != 0) {
  ...
  *(int *)(this + 0x174) = (*(int *)(this + 0x174) + 1) - iVar1 * (int)uVar3;
  ...
  AudioMgr::SendEventThrottled(psVar4,_FUN_0354227c,asStack_10);
...
/* NewPVPBattlePassLotteryPanel::TryToSelectNext() */

char __thiscall NewPVPBattlePassLotteryPanel::TryToSelectNext(NewPVPBattlePassLotteryPanel *this)
...
/* NewPVPBattlePassLotteryPanel::UpdateSelectFrame() */

void __thiscall NewPVPBattlePassLotteryPanel::UpdateSelectFrame(NewPVPBattlePassLotteryPanel *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::Update() */

void __thiscall NewPVPBattlePassLotteryPanel::Update(NewPVPBattlePassLotteryPanel *this)

{
  char cVar1;
  UIWidgetText *this_00;
  UINewPVPBattlePass *pUVar2;
  UIWidgetAnim *pUVar3;
  PVZ2UIButton *pPVar4;
  long lVar5;
  undefined4 local_1c;
  ...
  pUVar2 = (UINewPVPBattlePass *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
  local_1c = UINewPVPBattlePass::GetCurrentGemCost(pUVar2);
  ...
  nop();
  pUVar2 = (UINewPVPBattlePass *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
  cVar1 = UINewPVPBattlePass::IsLotteryMax(pUVar2);
  if (cVar1 != '\0') {
  ...
  pUVar2 = (UINewPVPBattlePass *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
  cVar1 = UINewPVPBattlePass::CanLottery(pUVar2);
  if (cVar1 != '\0') {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::RequestLottery() */

void __thiscall NewPVPBattlePassLotteryPanel::RequestLottery(NewPVPBattlePassLotteryPanel *this)

{
  ...
  amStack_d18 [48];
  string asStack_ce8 [2312];
  string asStack_3e0 [984];
  long local_8;
  ...
  this_01 = (UIInvitation *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
  local_d48[0] = UIInvitation::GetCurrentIntegral(this_01);
  ...
  FUN_0353b834(afStack_d38,this);
  std::string::string(asStack_d40,"[NET_CONNECTING]");
  DNetwork::requestMsg
            (this_02,asStack_3e0,(map *)amStack_d18,30.0,(function *)afStack_d38,true,true,
             asStack_d40,0);
  std::string::~string(asStack_d40);
  nop();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::ButtonDepress(int) */

void __thiscall
NewPVPBattlePassLotteryPanel::ButtonDepress(NewPVPBattlePassLotteryPanel *this,int param_1)

{
  ...
  local_8 = ___stack_chk_guard;
  if (param_1 == 0x2c) {
    pUVar3 = (UINewPVPBattlePass *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
    cVar1 = UINewPVPBattlePass::CanLottery(pUVar3);
    if (cVar1 == '\0') {
      ...
      RequestLottery(this);
      pUVar3 = (UINewPVPBattlePass *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
      iVar2 = UINewPVPBattlePass::GetCurrentGemCost(pUVar3);
      UIBattleOrder::AddIntegral((UIBattleOrder *)pUVar3,-iVar2);
      pUVar3 = (UINewPVPBattlePass *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
      UINewPVPBattlePass::AddDrawTimes(pUVar3);
      UISingletonDialog<EmptyDialog>::ShowDialog();
      this_01 = (UIBattleOrder *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
      UIBattleOrder::LockButton(this_01);
    }
  }
  if (local_8 == ___stack_chk_guard) {
    return;
...
/* non-virtual thunk to NewPVPBattlePassLotteryPanel::ButtonDepress(int) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::RequestChest(int) */

void __thiscall
NewPVPBattlePassLotteryPanel::RequestChest(NewPVPBattlePassLotteryPanel *this,int param_1)

{
  ...
  _PacketId::_PacketId((_PacketId *)asStack_ce8);
  FUN_0353b890(afStack_d38,this);
  std::string::string(asStack_d40,"[NET_CONNECTING]");
  DNetwork::requestMsg
            (this_01,asStack_3e0,(map *)amStack_d18,30.0,(function *)afStack_d38,true,true,
             asStack_d40,0);
  std::string::~string(asStack_d40);
  nop();
  std::function<bool(Sexy::Touch_const&)>::~function(afStack_d38);
...
/* NewPVPBattlePassLotteryPanel::DetermineSelect(UIMessageBox*, int) */

void __thiscall
NewPVPBattlePassLotteryPanel::DetermineSelect
          (NewPVPBattlePassLotteryPanel *this,UIMessageBox *param_1,int param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::ShowBonusUI() */

void __thiscall NewPVPBattlePassLotteryPanel::ShowBonusUI(NewPVPBattlePassLotteryPanel *this)
  ...
  if (*(long *)(this + 0x138) == 0) {
    ...
    *(PopingBonusUI **)(this + 0x138) = pPVar6;
    ...
    (**(code **)(**(long **)(gLawnApp + 0x360) + 0x98))
              (*(long **)(gLawnApp + 0x360),*(undefined8 *)(this + 0x138));
    if (*(long *)(this + 0x138) == 0) goto LAB_035462ec;
  }
  std::vector<Sexy::DataElement*,std::allocator<Sexy::DataElement*>>::vector(avStack_40);
  puVar2 = (undefined8 *)FUN_035399ec(*(undefined8 *)(this + 0x140),(long)*(int *)(this + 0x170));
  pwVar3 = (wchar_t *)FUN_03539a60(*puVar2,0);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::LotteryEffectFinish(std::string const&) */

void NewPVPBattlePassLotteryPanel::LotteryEffectFinish(string *param_1)

{
  ...
  *(undefined4 *)(param_1 + 0x1c0) = 0;
  ...
  this = (UIBattleOrder *)UISingletonDialog<UINewPVPBattlePass>::GetSingletonPtr();
  UIBattleOrder::UnlockButton(this);
  lVar2 = FUN_035399ec(*(undefined8 *)(param_1 + 0x140),(long)*(int *)(param_1 + 0x170));
  ...
  if (cVar1 == '\0') {
    ...
    FUN_0353b948(afStack_28,param_1);
    UICommonItemSelect::registerSelectRecall(this_00,(function *)afStack_28);
    std::function<bool(Sexy::Touch_const&)>::~function(afStack_28);
  }
  else {
    ShowBonusUI((NewPVPBattlePassLotteryPanel *)param_1);
  }
  if (local_8 == ___stack_chk_guard) {
    return;
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassLotteryPanel::InitView(std::vector<NewPVPBattlePassAward,
   std::allocator<NewPVPBattlePassAward> > const&) */

void __thiscall
NewPVPBattlePassLotteryPanel::InitView(NewPVPBattlePassLotteryPanel *this,vector *param_1)

{
  ...
  ulong uVar14;
  bool bVar15;
  UIRewardFrame *pUVar16;
  UIRewardFrame *local_18;
  string asStack_10 [8];
  long local_8;
  ...
  std::string::~string(asStack_10);
  nop();
  std::string::string((string *)&local_18,"UIImage_Material");
  pUVar2 = UI::Dialog::GetWidget<UIWidgetImage>((Dialog *)this,(string *)&local_18);
  std::string::string(asStack_10,"IMAGE_UI_NEW_PVP_BATTLE_PASS_VS_COIN");
  UIWidgetImage::SetImage(pUVar2,asStack_10);
  std::string::~string(asStack_10);
  nop();
  std::string::~string((string *)&local_18);
  nop();
  std::vector<NewPVPBattlePassAward,std::allocator<NewPVPBattlePassAward>>::clear
            ((vector<NewPVPBattlePassAward,std::allocator<NewPVPBattlePassAward>> *)(this + 0x140));
  uVar14 = 0;
  while( true ) {
    uVar8 = FUN_03539a94(*(undefined8 *)param_1,*(undefined8 *)(param_1 + 8));
    ...
    std::string::~string(asStack_10);
    local_18 = (UIRewardFrame *)0x0;
    lVar10 = FUN_03539bc0(*(undefined8 *)param_1,uVar14);
    cVar1 = std::vector<S2C_BonusInfo,std::allocator<S2C_BonusInfo>>::empty
                      ((vector<S2C_BonusInfo,std::allocator<S2C_BonusInfo>> *)(lVar10 + 0x20));
    if (cVar1 == '\0') {
      lVar10 = FUN_03539bc0(*(undefined8 *)param_1,uVar14);
      lVar10 = FUN_03539980(*(undefined8 *)(lVar10 + 0x20),0);
      this_01 = (CUILabel *)UIRewardFrameSelect::CreateUIRewardFrame(0,*(int *)(lVar10 + 4),bVar15);
      local_18 = (UIRewardFrame *)this_01;
      lVar10 = FUN_03539bc0(*(undefined8 *)param_1,uVar14);
      pPVar11 = (PrimeTypeface *)FUN_0353cb74(*(undefined4 *)(lVar10 + 0x1c));
      Lua::CUILabel::SetTypeface(this_01,pPVar11);
      pUVar16 = local_18;
      lVar10 = FUN_03539bc0(*(undefined8 *)param_1,uVar14);
      FUN_0353931c(asStack_10,*(undefined4 *)(lVar10 + 0x1c));
      ...
      this_00 = (vector<S2C_BonusInfo,std::allocator<S2C_BonusInfo>> *)
                FUN_03539bc0(*(undefined8 *)param_1,uVar14);
      cVar1 = std::vector<S2C_BonusInfo,std::allocator<S2C_BonusInfo>>::empty(this_00);
      if (cVar1 == '\0') {
        puVar5 = (undefined8 *)FUN_03539bc0(*(undefined8 *)param_1,uVar14);
        piVar6 = (int *)FUN_03539980(*puVar5,0);
        iVar13 = *piVar6;
        iVar12 = piVar6[1];
      }
      else {
      ...
      local_18 = (UIRewardFrame *)UIRewardFrameSelect::CreateUIRewardFrame(iVar13,iVar12,bVar15);
    }
    pUVar16 = local_18;
    lVar10 = FUN_03539bc0(*(undefined8 *)param_1,uVar14);
    if (0 < *(int *)(lVar10 + 0x38)) {
      std::string::string(asStack_10,"IMAGE_UI_GENERIC_GRAY_TRANSPARENT_BG");
      UIRewardFrame::SetLockString(pUVar16,asStack_10);
      std::string::~string(asStack_10);
      nop();
      pUVar16 = local_18;
    }
    ...
    pNVar7 = (NewPVPBattlePassAward *)FUN_03539bc0(*(undefined8 *)param_1,uVar14);
    std::vector<NewPVPBattlePassAward,std::allocator<NewPVPBattlePassAward>>::push_back
              ((vector<NewPVPBattlePassAward,std::allocator<NewPVPBattlePassAward>> *)(this + 0x140)
               ,pNVar7);
    uVar14 = uVar14 + 1;
  }
