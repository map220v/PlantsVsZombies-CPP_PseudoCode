// Class: LevelEditorTowerDefendWaveZombie


/* LevelEditorTowerDefendWaveZombie::~LevelEditorTowerDefendWaveZombie() */

void __thiscall
LevelEditorTowerDefendWaveZombie::~LevelEditorTowerDefendWaveZombie
          (LevelEditorTowerDefendWaveZombie *this)

{
  *(undefined ***)this = &PTR_GetClass_069678b0;
...
/* LevelEditorTowerDefendWaveZombie::LevelEditorTowerDefendWaveZombie(int, int) */

void __thiscall
LevelEditorTowerDefendWaveZombie::LevelEditorTowerDefendWaveZombie
          (LevelEditorTowerDefendWaveZombie *this,int param_1,int param_2)
...
/* LevelEditorTowerDefendWaveZombie::OnSlotAccept(Sexy::Point const&, std::string const&) */

void __thiscall
LevelEditorTowerDefendWaveZombie::OnSlotAccept
          (LevelEditorTowerDefendWaveZombie *this,Point *param_1,string *param_2)
...
/* LevelEditorTowerDefendWaveZombie::TouchEnded(Sexy::Touch const&) */

void __thiscall
LevelEditorTowerDefendWaveZombie::TouchEnded(LevelEditorTowerDefendWaveZombie *this,Touch *param_1)
  ...
  if ((*(int *)(this + 0xd4) == (int)*(undefined8 *)param_1) &&
    ...
    Sexy::Insets::Insets
              (aIStack_38,local_48 + iVar1 + iVar3,local_44 + (*(int *)(this + 0x54) - iVar4) / 2,
               iVar4,iVar4);
    FUN_04b54bcc(afStack_28,this_00,this);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LevelEditorTowerDefendWaveZombie::Reload() */

void __thiscall LevelEditorTowerDefendWaveZombie::Reload(LevelEditorTowerDefendWaveZombie *this)

{
  ...
  CustomLevelMgr::GetTowerDefendWaveZombie(iVar2,*(int *)(this + 0xe4),*(int *)(this + 0xd8));
