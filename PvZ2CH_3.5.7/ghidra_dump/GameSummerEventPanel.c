// Class: GameSummerEventPanel


/* GameSummerEventPanel::~GameSummerEventPanel() */

void __thiscall GameSummerEventPanel::~GameSummerEventPanel(GameSummerEventPanel *this)

{
  *(undefined ***)this = &PTR_GetClass_068443d0;
...
/* GameSummerEventPanel::Draw(Sexy::Graphics*) */

void __thiscall GameSummerEventPanel::Draw(GameSummerEventPanel *this,Graphics *param_1)

{
  ...
  pIVar8 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b04380);
  iVar1 = *(int *)(this + 0x50);
