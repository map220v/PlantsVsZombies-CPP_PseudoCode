// Class: DRotateCreator


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* DRotateCreator::create() */

void DRotateCreator::create(void)

{
  DRef *this;
  undefined8 uVar1;
  DRefPtr<DRotate> aDStack_10 [8];
  long local_8;
  
  local_8 = ___stack_chk_guard;
  DRefPtr<DRotate>::DRefPtr(aDStack_10);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* DRotateCreator::DRotateCreator() */

void __thiscall DRotateCreator::DRotateCreator(DRotateCreator *this)

{
  ...
  *(undefined ***)this = &PTR_nop_06a26090;
  this_00 = (DNodeLoader *)DSingleton<DNodeLoader>::getInstance();
  std::string::string(asStack_10,"DRotate");
