...
/* DScaleCreator::create() */

void DScaleCreator::create(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* DScaleCreator::DScaleCreator() */

void __thiscall DScaleCreator::DScaleCreator(DScaleCreator *this)

{
  ...
  *(undefined ***)this = &PTR_nop_06a260c0;
  this_00 = (DNodeLoader *)DSingleton<DNodeLoader>::getInstance();
  std::string::string(asStack_10,"DScale");
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* DScaleCreator::loadConfig(DAction*, DIniField*, std::string const&, DNodeLoaderConfig*) */

void DScaleCreator::loadConfig
...

{
  ...
  if (param_2 != (DIniField *)0x0) {
    std::string::string(asStack_40,"fromScale");
    std::string::string(asStack_30,"");
    DIniField::getItem(param_3,asStack_40);
    DString::DString(aDStack_c0,(string *)&local_20);
    std::string::~string((string *)&local_20);
    std::string::~string(asStack_30);
    nop();
    std::string::~string(asStack_40);
    nop();
    cVar2 = DString::empty(aDStack_c0);
    if (cVar2 == '\0') {
      pcVar5 = *(code **)(*(long *)param_2 + 0x60);
      DString::toFloat(aDStack_c0);
      (*pcVar5)(param_2);
    }
    std::string::string(asStack_40,"toScale");
    std::string::string(asStack_30,"");
    DIniField::getItem(param_3,asStack_40);
    DString::DString(aDStack_b0,(string *)&local_20);
    std::string::~string((string *)&local_20);
    std::string::~string(asStack_30);
    nop();
    std::string::~string(asStack_40);
    nop();
    cVar2 = DString::empty(aDStack_b0);
    if (cVar2 == '\0') {
      pcVar5 = *(code **)(*(long *)param_2 + 0x68);
      DString::toFloat(aDStack_b0);
      (*pcVar5)(param_2);
    }
    std::string::string(asStack_40,"byScale");
    std::string::string(asStack_30,"");
    DIniField::getItem(param_3,asStack_40);
    DString::DString(aDStack_a0,(string *)&local_20);
    std::string::~string((string *)&local_20);
    std::string::~string(asStack_30);
    nop();
    std::string::~string(asStack_40);
    nop();
    cVar2 = DString::empty(aDStack_a0);
    if (cVar2 == '\0') {
      pcVar5 = *(code **)(*(long *)param_2 + 0x70);
      DString::toFloat(aDStack_a0);
      (*pcVar5)(param_2);
    }
    ...
    std::string::string(asStack_c8,"toY");
    std::string::string(asStack_30,"");
    DIniField::getItem(param_3,asStack_c8);
    ...
    std::string::string(asStack_d0,"by");
    std::string::string(asStack_c8,"");
    DIniField::getItem(param_3,asStack_d0);
    ...
    if (cVar2 == '\0') {
      ...
      if (lVar3 == 2) {
        ...
        pDVar4 = (DString *)FUN_04f96020(local_20,1);
        fVar7 = (float)DString::toFloat(pDVar4);
        DVec2::DVec2((DVec2 *)asStack_c8,fVar6,fVar7);
        (*pcVar5)(param_2 + 0x90,asStack_c8);
      }
      std::vector<DString,std::allocator<DString>>::~vector
                ((vector<DString,std::allocator<DString>> *)&local_20);
    }
