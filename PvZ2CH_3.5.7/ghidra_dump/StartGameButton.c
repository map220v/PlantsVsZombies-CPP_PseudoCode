...
/* StartGameButton::cancelTouch() */

void __thiscall StartGameButton::cancelTouch(StartGameButton *this)
...
void __thiscall StartGameButton::~StartGameButton(StartGameButton *this)

{
  *(undefined ***)this = &PTR_GetClass_06851670;
  *(undefined ***)(this + 0x10) = &PTR__StartGameButton_06851810;
  *(undefined ***)(this + 0x168) = &PTR_ButtonPress_06851840;
...
/* non-virtual thunk to StartGameButton::~StartGameButton() */

void __thiscall StartGameButton::~StartGameButton(StartGameButton *this)

{
  ~StartGameButton(this + -0x10);
  return;
}
...
/* StartGameButton::StaticGetClass() */

long * StartGameButton::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"StartGameButton",uVar2,StaticNew);
  return sClass;
}


/* StartGameButton::GetClass() const */

long * StartGameButton::GetClass(void)
...
/* StartGameButton::handleTouch(Sexy::Touch const&) */

void __thiscall StartGameButton::handleTouch(StartGameButton *this,Touch *param_1)
...
switchD_04498c8c_caseD_2:
  ...
  case 1:
    if (cVar1 != '\0') {
      ...
      goto switchD_04498c8c_caseD_2;
    }
    uVar4 = 0;
    if (*(long *)(this + 0x178) != *(long *)param_1) goto switchD_04498c8c_caseD_2;
    goto LAB_04498ca4;
  case 3:
    lVar2 = *(long *)param_1;
...

{
  ...
  *(undefined ***)(this + 0x10) = &PTR__StartGameButton_06851810;
  *(undefined ***)(this + 0x168) = &PTR_ButtonPress_06851840;
  FUN_05478178(awStack_80,L"[LETS_ROCK_BUTTON]",aCStack_98);
  ...
  pIVar4 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b0bbd0);
  pIVar5 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b0bb88);
  ...
  uVar7 = MakeStretchableNewLawnButton
                    (0,(ButtonListener *)(this + 0x168),awStack_80,pPVar3,pIVar4,(Image *)0x0,pIVar5
                     ,iVar1 / 3,iVar2 / 3);
  ...
  *(undefined8 *)(this + 0x178) = 0;
  ...
  Delegate1wRet<StartGameButton,bool(StartGameButton::*)(Sexy::Touch_const&)>(aDStack_68,aCStack_98)
  ;
  ...
  Sexy::Delegate0::Delegate0<StartGameButton,void(StartGameButton::*)()>(aDStack_38,awStack_80);
...
/* StartGameButton::StaticNew() */

StartGameButton * StartGameButton::StaticNew(void)
...
/* StartGameButton::onEnterState_Initializing(WidgetState) */

void __thiscall StartGameButton::onEnterState_Initializing(StartGameButton *this)

{
  nop();
  FUN_04498a5c(this + 0x38,*(undefined4 *)(*(long *)(this + 0x170) + 0x50));
  FUN_04498a64(this + 0x3c,*(undefined4 *)(*(long *)(this + 0x170) + 0x54));
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* StartGameButton::Draw(Sexy::Graphics*) */

void __thiscall StartGameButton::Draw(StartGameButton *this,Graphics *param_1)

{
  ...
  cVar1 = FUN_04498d48(*(undefined4 *)(this + 0x68));
  if (cVar1 == '\0') {
...
/* non-virtual thunk to StartGameButton::Draw(Sexy::Graphics*) */
