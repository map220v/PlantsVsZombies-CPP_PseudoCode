// Class: ActivityCollectionCallofWish


/* ActivityCollectionCallofWish::ActivityCollectionCallofWish() */

void __thiscall
ActivityCollectionCallofWish::ActivityCollectionCallofWish(ActivityCollectionCallofWish *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662bd30;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662c098;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662c0e0;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionCallofWish_0662c100;
  return;
}
...
/* non-virtual thunk to ActivityCollectionCallofWish::~ActivityCollectionCallofWish() */

void __thiscall
ActivityCollectionCallofWish::~ActivityCollectionCallofWish(ActivityCollectionCallofWish *this)

{
  ~ActivityCollectionCallofWish(this + -0xe8);
  return;
}
...
{
  ~ActivityCollectionCallofWish(this);
  AK::FreeHook(this);
  return;
}
...
/* ActivityCollectionCallofWish::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionCallofWish::InitContainer
          (ActivityCollectionCallofWish *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a4f);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_CALLOFWISH");
...
/* non-virtual thunk to ActivityCollectionCallofWish::InitContainer(ActivityCollectionTabBase*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionCallofWish::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionCallofWish::Draw(ActivityCollectionCallofWish *this,Graphics *param_1)

{
  ...
  TodStringTranslate(L"[PLANT_CALLOFWISH_SHORT_DESCRIPTION]");
