// Class: TimeTravelSelEntranceUI


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TimeTravelSelEntranceUI::GetLayoutName() */

void __thiscall TimeTravelSelEntranceUI::GetLayoutName(TimeTravelSelEntranceUI *this)

{
  ...
  std::string::string(in_x8,"TimeTravelSelEntranceUI");
  nop();
...
/* TimeTravelSelEntranceUI::ButtonDepress(int) */

void __thiscall TimeTravelSelEntranceUI::ButtonDepress(TimeTravelSelEntranceUI *this,int param_1)
...
/* non-virtual thunk to TimeTravelSelEntranceUI::ButtonDepress(int) */
...
/* TimeTravelSelEntranceUI::Update() */

void __thiscall TimeTravelSelEntranceUI::Update(TimeTravelSelEntranceUI *this)

{
  ...
  if (this[0x1d0] != (TimeTravelSelEntranceUI)0x0) {
    ...
    uVar5 = 0;
    uVar2 = FUN_03ae99d0(uVar6,*(undefined8 *)(this + 400));
    while (uVar4 = uVar5, uVar5 < uVar2) {
      while( true ) {
        uVar5 = uVar4 + 1;
        puVar3 = (undefined8 *)FUN_03ae99dc(uVar6,uVar4);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TimeTravelSelEntranceUI::drawMapPaths(Sexy::Graphics*) */

void TimeTravelSelEntranceUI::drawMapPaths(Graphics *param_1)

{
  ...
  uVar13 = 0;
  lVar4 = FUN_03ae99cc(*(undefined8 *)(*(long *)(param_1 + 0x148) + 0x20));
  iVar2 = *(int *)(lVar4 + 0x3c);
  uVar12 = *(undefined8 *)(param_1 + 0x158);
  lVar4 = FUN_03ae9a38(uVar12,*(undefined8 *)(param_1 + 0x160));
  if (lVar4 != 0) {
    do {
      uVar11 = 0;
      while( true ) {
        puVar6 = (undefined8 *)FUN_03ae9a44(uVar12,uVar13);
        uVar14 = *puVar6;
        uVar7 = FUN_03ae9a4c(uVar14,puVar6[1]);
        fVar20 = (float)in_d1;
        ...
        puVar8 = (ulong *)std::
                          ...
                          ::_M_end((_Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
                                    *)puVar6[3]);
        local_b8 = *puVar8;
        lVar4 = FUN_03ae9a58(uVar14,uVar11);
        puVar6 = (undefined8 *)
                 std::
                 _Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
                 ::_M_end(*(_Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
        ...
        fVar18 = (float)FUN_03ae9d68(0x42820000);
        fVar19 = (float)FUN_03ae9d68(0x42bc0000);
        ...
        puVar6 = (undefined8 *)FUN_03ae9a44(*(undefined8 *)(param_1 + 0x158),uVar13);
        pcVar9 = (char *)FUN_03ae9a58(*puVar6,uVar11);
        uVar10 = (undefined1)in_x4;
        if (*pcVar9 == '\0') {
          PopAnimRig::SetRenderTransform(*(PopAnimRig **)(pcVar9 + 0x18),aSStack_58);
          puVar6 = (undefined8 *)FUN_03ae9a44(*(undefined8 *)(param_1 + 0x158),uVar13);
          lVar4 = FUN_03ae9a58(*puVar6,uVar11);
          fVar20 = (float)FUN_03ae9d68(local_b8 & 0xffffffff);
          fVar16 = (float)FUN_03ae9d68(local_b8._4_4_);
          ...
          fVar17 = (float)FUN_03ae9d68(0x42c20000);
          ...
          if (fVar16 < fVar20) {
            ...
            fVar20 = (float)FUN_03ae9d68(local_90);
          ...
          *(undefined8 *)(in_x1 + 0x30) = uStack_60;
          ...
          fVar20 = (float)FUN_03ae9d68(local_90);
          fVar16 = (float)FUN_03ae9d68(local_8c);
          in_d1 = (ulong)(uint)fVar16;
          WorldMapCamera::DrawPopAnimRig
      ...
      uVar13 = uVar13 + 1;
      uVar11 = FUN_03ae9a38(uVar12,*(undefined8 *)(param_1 + 0x160));
    } while (uVar13 < uVar11);
  }
...
/* TimeTravelSelEntranceUI::GetCurTimeTravelTDay() const */

undefined8 TimeTravelSelEntranceUI::GetCurTimeTravelTDay(void)

{
  ...
  if ((this_00 != (PlayerInfo *)0x0) &&
     (uVar1 = PlayerInfo::GetLevelOfTheDayInfo(this_00,0x2992), 0 < (int)uVar1)) {
    return uVar1;
  }
  return 1;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TimeTravelSelEntranceUI::TouchEnded(Sexy::Touch const&) */

void __thiscall TimeTravelSelEntranceUI::TouchEnded(TimeTravelSelEntranceUI *this,Touch *param_1)

{
  ...
  *this_00;
  ...
  iVar4 = FUN_03ae9d54(0xffffffdc);
  iVar5 = FUN_03ae9d54(0xffffffde);
  iVar6 = FUN_03ae9d54(0x48);
  iVar7 = FUN_03ae9d54(0x3a);
  Sexy::Insets::Insets((Insets *)&local_18,iVar4,iVar5,iVar6,iVar7);
  iVar4 = GetCurTimeTravelTDay();
  iVar4 = iVar4 + -1;
  if (-1 < iVar4) {
    uVar11 = *(undefined8 *)(this + 0x170);
    uVar8 = FUN_03ae9a2c(uVar11,*(undefined8 *)(this + 0x178));
    if ((ulong)(long)iVar4 < uVar8) {
      puVar9 = (undefined8 *)FUN_03ae9a1c(uVar11,(long)iVar4);
      this_00 = (_Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
                 *)*puVar9;
      cVar3 = FUN_03ae99b0(this_00[0xf1]);
      if (cVar3 != '\0') {
        puVar10 = (undefined4 *)
                  std::
                  _Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
                  ::_M_end(this_00);
        fVar12 = (float)FUN_03ae9d68(*puVar10);
        fVar13 = (float)FUN_03ae9d68(puVar10[1]);
        fVar12 = (float)PlantDefenceEntranceUI::TransformPointFromCamera
                                  ((PlantDefenceEntranceUI *)this,fVar12,fVar13);
        if (((float)local_18 + fVar12 <= (float)iVar1) &&
          ...
          if (((float)local_14 + fVar13 <= (float)iVar2) &&
            ...
            this[0x1d0] = (TimeTravelSelEntranceUI)0x0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TimeTravelSelEntranceUI::TimeTravelSelEntranceUI() */

void __thiscall TimeTravelSelEntranceUI::TimeTravelSelEntranceUI(TimeTravelSelEntranceUI *this)

{
  ...
  *(undefined ***)this = &PTR_GetClass_067238d0;
  *(undefined **)(this + 0xd8) = &DAT_06723c20;
  ...
  *(undefined8 *)(this + 0x150) = 0;
  ...
  this[0x1d0] = (TimeTravelSelEntranceUI)0x1;
...
/* TimeTravelSelEntranceUI::DrawOverlay(Sexy::Graphics*) */

void TimeTravelSelEntranceUI::DrawOverlay(Graphics *param_1)

{
  ...
  *this_00;
  ...
  if (*(uint *)(gLawnApp + 0x6a) == 0xaaa) {
    ...
    fVar19 = 0.25;
    if (*(uint *)(gLawnApp + 0x6c) == 0x600) goto LAB_03aeae4c;
  }
  fVar19 = 0.4;
LAB_03aeae4c:
  ...
  while( true ) {
    ...
    uVar10 = FUN_03ae9a10(uVar15,*(undefined8 *)(param_1 + 0x1a8));
    if (uVar10 <= uVar14) break;
    puVar11 = (undefined8 *)FUN_03ae9a1c(*(undefined8 *)(param_1 + 0x170),uVar14);
    pfVar4 = (float *)std::
                      _Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
                      ::_M_end((_Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
                                *)*puVar11);
    fVar18 = *pfVar4;
    pRVar5 = (RtWeakPtr<Sexy::ResourceInfo> *)FUN_03ae9a24(uVar15,uVar14);
    ...
    fVar18 = (float)FUN_03ae9d68(fVar18 - fVar19 * 0.5 * (float)iVar3);
    puVar11 = (undefined8 *)FUN_03ae9a1c(*(undefined8 *)(param_1 + 0x170),uVar14);
    lVar7 = std::
            _Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
            ::_M_end((_Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
    ...
    pRVar5 = (RtWeakPtr<Sexy::ResourceInfo> *)FUN_03ae9a24(*(undefined8 *)(param_1 + 0x1a0),uVar14);
    pSVar8 = (SalesProgressBar *)Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get(pRVar5);
    iVar3 = SalesProgressBar::GetCurrentLevel(pSVar8);
    fVar20 = (float)FUN_03ae9d68(fVar20 - fVar19 * 0.8 * (float)iVar3);
    this_01 = *(WorldMapCamera **)(param_1 + 0x138);
    this = (RtMixedPtr *)FUN_03ae9a24(*(undefined8 *)(param_1 + 0x1a0),uVar14);
    pIVar9 = Sexy::RtMixedPtr::operator_cast_to_Image_(this);
    pRVar5 = (RtWeakPtr<Sexy::ResourceInfo> *)FUN_03ae9a24(*(undefined8 *)(param_1 + 0x1a0),uVar14);
    pLVar6 = (LotteryResultProgressBar *)Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get(pRVar5);
    iVar3 = LotteryResultProgressBar::GetCurrentLevel(pLVar6);
    fVar16 = (float)FUN_03ae9d68((float)iVar3 * fVar19);
    pRVar5 = (RtWeakPtr<Sexy::ResourceInfo> *)FUN_03ae9a24(*(undefined8 *)(param_1 + 0x1a0),uVar14);
    pSVar8 = (SalesProgressBar *)Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get(pRVar5);
    iVar3 = SalesProgressBar::GetCurrentLevel(pSVar8);
    fVar17 = (float)FUN_03ae9d68((float)iVar3 * fVar19);
  ...
  while( true ) {
    ...
    uVar10 = FUN_03ae9a2c(uVar15,*(undefined8 *)(param_1 + 0x178));
    if (uVar10 <= uVar14) break;
    puVar11 = (undefined8 *)FUN_03ae9a1c(uVar15,uVar14);
    this_00 = (_Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
               *)*puVar11;
    sVar2 = FUN_03ae99c0(*(undefined2 *)(this_00 + 0xe0));
    puVar11 = (undefined8 *)FUN_03ae99dc(*(undefined8 *)(param_1 + 0x188),(long)sVar2);
    puVar12 = (undefined4 *)
              std::
              _Rb_tree<int,std::pair<int_const,std::wstring>,std::_Select1st<std::pair<int_const,std::wstring>>,std::less<int>,std::allocator<std::pair<int_const,std::wstring>>>
              ::_M_end(this_00);
    fVar19 = (float)FUN_03ae9d68(*puVar12);
    fVar18 = (float)FUN_03ae9d68(puVar12[1]);
    WorldMapCamera::DrawPopAnimRig
...
/* TimeTravelSelEntranceUI::purgeMapPathGroups() */

void __thiscall TimeTravelSelEntranceUI::purgeMapPathGroups(TimeTravelSelEntranceUI *this)

{
  ...
  uVar8 = 0;
  lVar1 = FUN_03ae9a38(uVar7,*(undefined8 *)(this + 0x160));
  if (lVar1 != 0) {
    do {
      uVar5 = 0;
      puVar2 = (undefined8 *)FUN_03ae9a44(uVar7,uVar8);
      uVar6 = *puVar2;
      uVar3 = FUN_03ae9a4c(uVar6,puVar2[1]);
      if (uVar3 != 0) {
        do {
          lVar1 = FUN_03ae9a58(uVar6,uVar5);
          plVar4 = *(long **)(lVar1 + 0x18);
          if (plVar4 != (long *)0x0) {
            (**(code **)(*plVar4 + 0x18))(plVar4);
            puVar2 = (undefined8 *)FUN_03ae9a44(*(undefined8 *)(this + 0x158),uVar8);
            lVar1 = FUN_03ae9a58(*puVar2,uVar5);
      ...
      uVar8 = uVar8 + 1;
      uVar5 = FUN_03ae9a38(uVar7,*(undefined8 *)(this + 0x160));
    } while (uVar8 < uVar5);
  }
...

{
  ...
  *(undefined **)(this + 0xd8) = &DAT_06723c20;
  ...
  uVar4 = 0;
  uVar1 = FUN_03ae99d0(uVar5,*(undefined8 *)(this + 400));
  while (uVar3 = uVar4, uVar4 < uVar1) {
    while( true ) {
      uVar4 = uVar3 + 1;
      plVar2 = (long *)FUN_03ae99dc(uVar5,uVar3);
      plVar2 = (long *)*plVar2;
      ...
      uVar1 = FUN_03ae99d0(uVar5,*(undefined8 *)(this + 400));
      uVar3 = uVar4;
      if (uVar1 <= uVar4) goto LAB_03aeb668;
    }
  }
LAB_03aeb668:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TimeTravelSelEntranceUI::rebuildMapPathGroups(WorldData*) */

void __thiscall
TimeTravelSelEntranceUI::rebuildMapPathGroups(TimeTravelSelEntranceUI *this,WorldData *param_1)

{
  ...
  if (param_1 != (WorldData *)0x0) {
    ...
    paVar5 = (allocator *)
             FUN_03ae99e4(*(undefined8 *)(param_1 + 0x20),*(undefined8 *)(param_1 + 0x28));
    std::vector<MapEventItem_const*,std::allocator<MapEventItem_const*>>::vector
              ((ulong)&local_40,paVar5);
    for (uVar16 = 0; uVar8 = local_40, uVar9 = FUN_03ae9a60(local_40,local_38), uVar16 < uVar9;
        uVar16 = uVar16 + 1) {
      this_00 = (GachaConfig *)FUN_03ae9a04(*(undefined8 *)(param_1 + 0x20),uVar16);
      psVar10 = (string *)
                eastl::
      ...
      if (cVar1 == '\0') {
        ...
        FUN_03ae9994((hashtable<EA::Text::GlyphCache::GlyphInfo,eastl::pair<EA::Text::GlyphCache::GlyphInfo_const,EA::Text::GlyphTextureInfo>,EA::Allocator::CoreAllocatorAdapter<EA::Allocator::ICoreAllocator>,eastl::use_first<eastl::pair<EA::Text::GlyphCache::GlyphInfo_const,EA::Text::GlyphTextureInfo>>,eastl::equal_to<EA::Text::GlyphCache::GlyphInfo>,EA::Text::GlyphCache::GlyphInfoHash,eastl::mod_range_hashing,eastl::default_ranged_hash,eastl::prime_rehash_policy,false,true,true>
                      *)(this_00 + 0xd8),uVar8);
        this_00 = (GachaConfig *)FUN_03ae9a04(*(undefined8 *)(param_1 + 0x20),uVar16);
      }
      ...
      if (cVar1 == '\0') {
        uVar8 = WorldData::FindEventByName(param_1,psVar10);
        FUN_03ae999c(this_00 + 0xd0,uVar8);
        this_00 = (GachaConfig *)FUN_03ae9a04(*(undefined8 *)(param_1 + 0x20),uVar16);
      }
      if ((int)uVar16 < iVar3) {
        FUN_03ae99a8(this_00 + 0xf1,1);
        if ((int)uVar16 < iVar3 + -1) {
          lVar6 = FUN_03ae9a04(*(undefined8 *)(param_1 + 0x20),uVar16);
          FUN_03ae9cec(lVar6 + 0xf2);
        }
      }
      else {
        FUN_03ae99a8(this_00 + 0xf1,0);
      }
      lVar6 = FUN_03ae9a04(*(undefined8 *)(param_1 + 0x20),uVar16);
      FUN_03ae99c4(lVar6 + 0xe8,param_1);
      puVar7 = (undefined8 *)FUN_03ae9a6c(local_40,uVar16);
      uVar8 = FUN_03ae9a04(*(undefined8 *)(param_1 + 0x20),uVar16);
      *puVar7 = uVar8;
    }
    puVar7 = (undefined8 *)FUN_03ae9a6c(uVar8,(long)(iVar3 + -1));
                             ...
                             ((__normal_iterator *)&local_50,(__normal_iterator *)&local_48), bVar2)
    {
      ...
      lVar6 = FUN_03ae99a4(*(undefined8 *)(pMVar11 + 0xb0));
      if (lVar6 != 0) {
        uVar8 = *(undefined8 *)(this + 0x158);
        uVar9 = FUN_03ae9a38(uVar8,*(undefined8 *)(this + 0x160));
        for (uVar16 = 0; uVar16 != uVar9; uVar16 = uVar16 + 1) {
          lVar13 = FUN_03ae9a44(uVar8,uVar16);
          if (lVar6 == *(long *)(lVar13 + 0x18)) {
            if ((int)uVar16 != -1) goto LAB_03aec5d8;
            break;
          }
        }
        uVar16 = uVar9 & 0xffffffff;
        TriRepGenerator::PointGroup::BarGroup::BarGroup(aBStack_28);
        local_10 = FUN_03ae99a4(*(undefined8 *)(pMVar11 + 0xb0));
...
LAB_03aec5d8:
        ...
        local_18 = pMVar11;
        pPVar14 = (PopAnim *)FUN_03ae99cc(*(undefined8 *)(*(long *)(this + 0x148) + 0x20));
        ...
        PlantDefenceEntranceUI::SetMapPathAnimationState
                  ((PlantDefenceEntranceUI *)this,(MapPath *)aBStack_28,iVar4 <= iVar3);
        this_01 = (vector<MapPath,std::allocator<MapPath>> *)
                  FUN_03ae9a44(*(undefined8 *)(this + 0x158),(long)(int)uVar16);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TimeTravelSelEntranceUI::loadData() */

void __thiscall TimeTravelSelEntranceUI::loadData(TimeTravelSelEntranceUI *this)

{
  ...
  local_8 = ___stack_chk_guard;
  uVar9 = 0;
  std::string::string((string *)&local_40,"event");
  ...
  while( true ) {
    ...
    uVar6 = FUN_03ae99e4(uVar8,*(undefined8 *)(pWVar5 + 0x28));
    if (uVar6 <= uVar9) break;
    this_00 = (AsyncTaskQueue *)FUN_03ae9a04(uVar8,uVar9);
    uVar2 = FUN_03ae99d0(*(undefined8 *)(this + 0x188),*(undefined8 *)(this + 400));
    FUN_03ae99b8(this_00 + 0xe0,uVar2);
    CachedResourcePtr::operator_cast_to_RtWeakPtr((CachedResourcePtr *)&DAT_06ac8d90);
    iVar3 = FUN_03ae9990(*(undefined4 *)(this_00 + 0x78));
    if (iVar3 == 3) {
      CachedResourcePtr::operator_cast_to_RtWeakPtr((CachedResourcePtr *)&DAT_06ac8d68);
    ...
    fVar10 = (float)FUN_03ae9d68(0x42c40000);
    fVar11 = (float)FUN_03ae9d68(0x42d00000);
    FUN_03ae9974(-fVar10,-fVar11,auStack_28,auStack_1c);
    PopAnimRig::SetRenderTransform((PopAnimRig *)this_01,aSStack_30);
    cVar1 = FUN_03ae99b4(this_00[0xf2]);
    if (cVar1 == '\0') {
      cVar1 = FUN_03ae99b0(this_00[0xf1]);
      if (cVar1 == '\0') {
    ...
    std::vector<MapRenderItem,std::allocator<MapRenderItem>>::push_back
              ((vector<MapRenderItem,std::allocator<MapRenderItem>> *)(this + 0x170),
               (string *)&local_40);
    auVar12 = Sexy::AsyncTaskQueue::GetTasks(this_00);
    Sexy::StringToUpper(auVar12._0_8_,auVar12._8_8_);
    uVar8 = FUN_0547429c(asStack_58);
    Sexy::StrFormat("IMAGE_UI_UNIVERSE_WORLDS_%s",asStack_50,uVar8);
    FindResourceId<Sexy::Image>(asStack_50,*(int *)(gLawnApp + 0xd8));
  ...
  if (this_03 != (PlayerInfo *)0x0) {
    uVar4 = PlayerInfo::GetLevelOfTheDayRemainDays(this_03,0x2992);
    if ((int)uVar4 < 1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TimeTravelSelEntranceUI::OnCreate() */

void TimeTravelSelEntranceUI::OnCreate(void)

{
  ...
  *(PopAnimRig **)(in_x0 + 0x150) = pPVar6;
  ...
  std::string::~string(asStack_40);
  nop();
  loadData((TimeTravelSelEntranceUI *)in_x0);
