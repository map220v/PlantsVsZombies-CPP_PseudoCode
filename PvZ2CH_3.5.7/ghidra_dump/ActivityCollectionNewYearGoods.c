// Class: ActivityCollectionNewYearGoods


/* ActivityCollectionNewYearGoods::ActivityCollectionNewYearGoods() */

void __thiscall
ActivityCollectionNewYearGoods::ActivityCollectionNewYearGoods(ActivityCollectionNewYearGoods *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662b4f0;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662b858;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662b8a0;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionNewYearGoods_0662b8c0;
  return;
}
...
void __thiscall
ActivityCollectionNewYearGoods::~ActivityCollectionNewYearGoods
          (ActivityCollectionNewYearGoods *this)
...
/* non-virtual thunk to ActivityCollectionNewYearGoods::~ActivityCollectionNewYearGoods() */
...
{
  ~ActivityCollectionNewYearGoods(this + -0xe8);
  return;
}
...
/* ActivityCollectionNewYearGoods::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionNewYearGoods::InitContainer
          (ActivityCollectionNewYearGoods *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a6c);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_NEWYEARGOODS");
...
/* non-virtual thunk to ActivityCollectionNewYearGoods::InitContainer(ActivityCollectionTabBase*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionNewYearGoods::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionNewYearGoods::Draw(ActivityCollectionNewYearGoods *this,Graphics *param_1)

{
  ...
  pIVar8 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa05e0);
  ...
  TodStringTranslate(L"[NEWYEAR_GOODS_SHORT_DESCRIPTION]");
