// Class: ActivityCollectionCustomVoting


/* ActivityCollectionCustomVoting::ActivityCollectionCustomVoting() */

void __thiscall
ActivityCollectionCustomVoting::ActivityCollectionCustomVoting(ActivityCollectionCustomVoting *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662fa20;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662fd88;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662fdd0;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionCustomVoting_0662fdf0;
  return;
}
...
void __thiscall
ActivityCollectionCustomVoting::~ActivityCollectionCustomVoting
          (ActivityCollectionCustomVoting *this)
...
/* non-virtual thunk to ActivityCollectionCustomVoting::~ActivityCollectionCustomVoting() */
...
{
  ~ActivityCollectionCustomVoting(this + -0xe8);
  return;
}
...
/* ActivityCollectionCustomVoting::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionCustomVoting::InitContainer
          (ActivityCollectionCustomVoting *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a3e);
  uVar7 = CachedUIResourcePtr<Sexy::Image>::operator->
                    ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa0560);
...
/* non-virtual thunk to ActivityCollectionCustomVoting::InitContainer(ActivityCollectionTabBase*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionCustomVoting::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionCustomVoting::Draw(ActivityCollectionCustomVoting *this,Graphics *param_1)

{
  ...
  pIVar8 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa0588);
  ...
  TodStringTranslate(L"[ACTIVITY_COLLECTION_CUSTOM_VOTING_DESCRIPTION]");
