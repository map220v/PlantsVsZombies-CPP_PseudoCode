// Class: RiftaShopButton


/* RiftaShopButton::~RiftaShopButton() */

void __thiscall RiftaShopButton::~RiftaShopButton(RiftaShopButton *this)

{
  *(undefined ***)this = &PTR_GetClass_069b88e0;
  *(undefined ***)(this + 0x198) = &PTR__RiftaShopButton_069b8c40;
  *(undefined ***)(this + 0x300) = &PTR_ButtonPress_069b8c68;
...
/* non-virtual thunk to RiftaShopButton::~RiftaShopButton() */

void __thiscall RiftaShopButton::~RiftaShopButton(RiftaShopButton *this)

{
  ~RiftaShopButton(this + -0x198);
  return;
}
...
/* RiftaShopButton::InitView() */

void __thiscall RiftaShopButton::InitView(RiftaShopButton *this)

{
  ...
  iVar3 = FUN_04d84c28(6);
  iVar5 = iVar5 + iVar3 * -2;
  iVar4 = FUN_04d84c28(3);
  iVar1 = iVar3 * 2 + iVar5;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RiftaShopButton::RiftaShopButton(int) */

void __thiscall RiftaShopButton::RiftaShopButton(RiftaShopButton *this,int param_1)
...
/* RiftaShopButton::BuyConfirm(UIMessageBox*, int) */

void __thiscall RiftaShopButton::BuyConfirm(RiftaShopButton *this,UIMessageBox *param_1,int param_2)

{
  ...
  if ((param_2 == 1) &&
     (iVar1 = FUN_04d843b8(*(undefined8 *)(this + 0x340),*(undefined8 *)(this + 0x350)), iVar1 != 0)
     ) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RiftaShopButton::ButtonDepress(int) */

void __thiscall RiftaShopButton::ButtonDepress(RiftaShopButton *this,int param_1)

{
  ...
  if ((*(int *)(this + 0xd4) == param_1) &&
    ...
    TodStringTranslate(L"[RIFTA_SHOP_BUY_CONFIRM]");
    ...
    Delegate2<RiftaShopButton,void(RiftaShopButton::*)(UIMessageBox*,int)>(aDStack_38,awStack_50);
...
/* non-virtual thunk to RiftaShopButton::ButtonDepress(int) */
