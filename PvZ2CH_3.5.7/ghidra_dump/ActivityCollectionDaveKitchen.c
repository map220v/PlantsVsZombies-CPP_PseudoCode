// Class: ActivityCollectionDaveKitchen


/* ActivityCollectionDaveKitchen::ActivityCollectionDaveKitchen() */

void __thiscall
ActivityCollectionDaveKitchen::ActivityCollectionDaveKitchen(ActivityCollectionDaveKitchen *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662c150;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662c4b8;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662c500;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionDaveKitchen_0662c520;
  return;
}
...
/* non-virtual thunk to ActivityCollectionDaveKitchen::~ActivityCollectionDaveKitchen() */

void __thiscall
ActivityCollectionDaveKitchen::~ActivityCollectionDaveKitchen(ActivityCollectionDaveKitchen *this)

{
  ~ActivityCollectionDaveKitchen(this + -0xe8);
  return;
}
...
{
  ~ActivityCollectionDaveKitchen(this);
  AK::FreeHook(this);
  return;
}
...
/* ActivityCollectionDaveKitchen::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionDaveKitchen::InitContainer
          (ActivityCollectionDaveKitchen *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a7e);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_DAVEKITCHEN");
  ...
  TodStringTranslate(L"[DAVEKITCHEN_DESCRIPTION_TITLE]");
  TodStringTranslate(L"[DAVEKITCHEN_DESCRIPTION]");
...
/* non-virtual thunk to ActivityCollectionDaveKitchen::InitContainer(ActivityCollectionTabBase*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionDaveKitchen::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionDaveKitchen::Draw(ActivityCollectionDaveKitchen *this,Graphics *param_1)

{
  ...
  TodStringTranslate(L"[DAVEKITCHEN_SHORT_DESCRIPTION]");
