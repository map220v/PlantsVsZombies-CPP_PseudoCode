// Class: AvatarNameMapperServerID


/* AvatarNameMapperServerID::GetInstance() */

undefined1 * AvatarNameMapperServerID::GetInstance(void)

{
  ...
  if (((GetInstance()::instance & 1) == 0) &&
    ...
    AvatarNameMapperServerID((AvatarNameMapperServerID *)GetInstance()::instance);
    __cxa_guard_release(&GetInstance()::instance);
    __cxa_atexit(~AvatarNameMapperServerID,GetInstance()::instance,&DAT_06a88000);
...
/* AvatarNameMapperServerID::~AvatarNameMapperServerID() */

void __thiscall AvatarNameMapperServerID::~AvatarNameMapperServerID(AvatarNameMapperServerID *this)

{
  *(undefined ***)this = &PTR__AvatarNameMapperServerID_066084b0;
