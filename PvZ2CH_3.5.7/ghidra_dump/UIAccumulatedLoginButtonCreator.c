// Class: UIAccumulatedLoginButtonCreator


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UIAccumulatedLoginButtonCreator::create() */

void UIAccumulatedLoginButtonCreator::create(void)

{
  DRef *this;
  undefined8 uVar1;
  DRefPtr<UIAccumulatedLoginButton> aDStack_10 [8];
  long local_8;
  
  local_8 = ___stack_chk_guard;
  DRefPtr<UIAccumulatedLoginButton>::DRefPtr(aDStack_10);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UIAccumulatedLoginButtonCreator::UIAccumulatedLoginButtonCreator() */

void __thiscall
UIAccumulatedLoginButtonCreator::UIAccumulatedLoginButtonCreator
          (UIAccumulatedLoginButtonCreator *this)

{
  ...
  *(undefined ***)this = &PTR_nop_06a26340;
  this_00 = (DNodeLoader *)DSingleton<DNodeLoader>::getInstance();
  std::string::string(asStack_10,"UIAccumulatedLoginButton");
...
/* UIAccumulatedLoginButtonCreator::loadConfigAfter(DTransformNode*, DIniField*, std::string const&,
   DNodeLoaderConfig*) */

undefined8
UIAccumulatedLoginButtonCreator::loadConfigAfter
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UIAccumulatedLoginButtonCreator::loadConfig(DTransformNode*, DIniField*, std::string const&,
   DNodeLoaderConfig*) */

void __thiscall
UIAccumulatedLoginButtonCreator::loadConfig
          (UIAccumulatedLoginButtonCreator *this,DTransformNode *param_1,DIniField *param_2,
          string *param_3,DNodeLoaderConfig *param_4)
