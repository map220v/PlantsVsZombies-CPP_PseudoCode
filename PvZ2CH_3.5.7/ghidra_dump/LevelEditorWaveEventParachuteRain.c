// Class: LevelEditorWaveEventParachuteRain


/* LevelEditorWaveEventParachuteRain::~LevelEditorWaveEventParachuteRain() */

void __thiscall
LevelEditorWaveEventParachuteRain::~LevelEditorWaveEventParachuteRain
          (LevelEditorWaveEventParachuteRain *this)

{
  *(undefined ***)this = &PTR_GetClass_069693a0;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_069696c8;
...
/* LevelEditorWaveEventParachuteRain::ButtonDepress(int) */

void __thiscall
LevelEditorWaveEventParachuteRain::ButtonDepress
          (LevelEditorWaveEventParachuteRain *this,int param_1)

{
  ...
  uVar1 = ClampInt(iVar2,2,7);
  *(undefined4 *)(this + 0xf4) = uVar1;
  this_00 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
  CustomLevelMgr::SetParachuteRainColumnEnd
            (this_00,*(int *)(this + 0xf0),*(int *)(this + 0xf4) + -1);
  return;
}


/* non-virtual thunk to LevelEditorWaveEventParachuteRain::ButtonDepress(int) */
...
/* LevelEditorWaveEventParachuteRain::Reload() */

void __thiscall LevelEditorWaveEventParachuteRain::Reload(LevelEditorWaveEventParachuteRain *this)

{
  ...
  iVar1 = CustomLevelMgr::GetParachuteRainColumnEnd(pCVar3,*(int *)(this + 0xf0));
  uVar2 = ClampInt(iVar1 + 1,2,7);
  *(undefined4 *)(this + 0xf4) = uVar2;
  pCVar3 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
  CustomLevelMgr::SetParachuteRainColumnEnd(pCVar3,*(int *)(this + 0xf0),*(int *)(this + 0xf4) + -1)
  ;
  return;
}
...
/* LevelEditorWaveEventParachuteRain::Init(int) */

void __thiscall
LevelEditorWaveEventParachuteRain::Init(LevelEditorWaveEventParachuteRain *this,int param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LevelEditorWaveEventParachuteRain::Draw(Sexy::Graphics*) */

void __thiscall
LevelEditorWaveEventParachuteRain::Draw(LevelEditorWaveEventParachuteRain *this,Graphics *param_1)

{
  ...
  TodStringTranslate(L"[LEVEL_EDITOR_WAVE_EVENT_PARACHUTE_RAIN_TITLE]");
  ...
  TodStringTranslate(L"[LEVEL_EDITOR_WAVE_EVENT_PARACHUTE_RAIN_BTN_LEFT]");
  iVar1 = FUN_04b54f08(0x32);
  ...
  TodStringTranslate(L"[LEVEL_EDITOR_WAVE_EVENT_PARACHUTE_RAIN_TEXT]");
