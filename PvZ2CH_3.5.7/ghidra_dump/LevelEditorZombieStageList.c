// Class: LevelEditorZombieStageList


/* LevelEditorZombieStageList::GetMaxPageIndex() */

int __thiscall LevelEditorZombieStageList::GetMaxPageIndex(LevelEditorZombieStageList *this)

{
  ...
  uVar2 = FUN_04b4bb7c(*(undefined8 *)(this + 0xf8),*(undefined8 *)(this + 0x100));
  iVar3 = (int)(uVar2 / 5);
  if (uVar2 != (uVar2 / 5) * 5) {
    iVar3 = iVar3 + 1;
  }
...
/* LevelEditorZombieStageList::SetPageIndex(int) */

void __thiscall
LevelEditorZombieStageList::SetPageIndex(LevelEditorZombieStageList *this,int param_1)
...
LAB_04b4c60c:
  ...
  while( true ) {
    ...
    if ((iVar1 < iVar4) || (iVar4 + 5 <= iVar1)) {
      ...
      plVar11 = (long *)*puVar9;
      iVar1 = FUN_04b4c0a8(0x5a);
      iVar2 = FUN_04b4c0a8(0x32);
      uVar3 = FUN_04b4c0a8(0x28);
      (**(code **)(*plVar11 + 0x198))(plVar11,-iVar1,-iVar2,iVar1,uVar3);
      ...
      puVar9 = (undefined8 *)FUN_04b4bb88(uVar10,uVar12);
      plVar11 = (long *)*puVar9;
      uVar3 = FUN_04b4c0a8(5);
      iVar4 = FUN_04b4c0a8(10);
      iVar5 = FUN_04b4c0a8(0x32);
      uVar6 = FUN_04b4c0a8(0x5a);
...
/* LevelEditorZombieStageList::ButtonDepress(int) */

void __thiscall
LevelEditorZombieStageList::ButtonDepress(LevelEditorZombieStageList *this,int param_1)
...
/* non-virtual thunk to LevelEditorZombieStageList::ButtonDepress(int) */
...
/* LevelEditorZombieStageList::LevelEditorZombieStageList() */

void __thiscall
LevelEditorZombieStageList::LevelEditorZombieStageList(LevelEditorZombieStageList *this)

{
  Sexy::Widget::Widget((Widget *)this);
  Sexy::ButtonListener::ButtonListener((ButtonListener *)(this + 0xd8));
  *(undefined ***)this = &PTR_GetClass_06962d20;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_06963048;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LevelEditorZombieStageList::Draw(Sexy::Graphics*) */

void __thiscall LevelEditorZombieStageList::Draw(LevelEditorZombieStageList *this,Graphics *param_1)

{
  ...
  uVar1 = CachedUIResourcePtr<Sexy::Image>::operator->
                    ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06b85dc8);
...
{
  ~LevelEditorZombieStageList(this);
  AK::FreeHook(this);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LevelEditorZombieStageList::Init(std::vector<std::string, std::allocator<std::string > > const&)
    */

void __thiscall LevelEditorZombieStageList::Init(LevelEditorZombieStageList *this,vector *param_1)

{
  ...
  *(PVZ2UIButton **)(this + 0xe8) = pPVar11;
  ...
  uVar4 = FUN_04b4c0a8(0);
  uVar5 = FUN_04b4c0a8(0x78);
