// Class: NewPVPBattlePassTurnPagesItem


/* NewPVPBattlePassTurnPagesItem::~NewPVPBattlePassTurnPagesItem() */

void __thiscall
NewPVPBattlePassTurnPagesItem::~NewPVPBattlePassTurnPagesItem(NewPVPBattlePassTurnPagesItem *this)

{
  *(undefined ***)this = &PTR_GetClass_06656350;
...
{
  ~NewPVPBattlePassTurnPagesItem(this);
  AK::FreeHook(this);
  return;
}
...
/* NewPVPBattlePassTurnPagesItem::Draw(Sexy::Graphics*) */

void __thiscall
NewPVPBattlePassTurnPagesItem::Draw(NewPVPBattlePassTurnPagesItem *this,Graphics *param_1)

{
  ...
  uVar5 = CachedUIResourcePtr<Sexy::Image>::operator->
                    ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa5950);
  Draw9SliceImage(param_1,aIStack_18,uVar5);
  iVar1 = *(int *)(this + 0xd4);
  if (iVar1 == 1) {
    this_00 = (CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa5bf8;
  }
  else if (iVar1 == 2) {
    this_00 = (CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa5840;
  }
  else {
    if (iVar1 != 3) {
      std::to_string<ActivityTypeID>((ActivityTypeID *)(this + 0xd4));
      Sexy::ToWString(asStack_38);
      iVar1 = FUN_0353ba6c(10);
      iVar2 = FUN_0353ba6c(0xb);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NewPVPBattlePassTurnPagesItem::InitView(int, NewPVPBattlePassRankData const&) */

void __thiscall
NewPVPBattlePassTurnPagesItem::InitView
          (NewPVPBattlePassTurnPagesItem *this,int param_1,NewPVPBattlePassRankData *param_2)

{
  ...
  *(int *)(this + 0xd4) = param_1;
  local_8 = ___stack_chk_guard;
  BattleOrderRankData::operator=
            ((BattleOrderRankData *)(this + 0xe0),(BattleOrderRankData *)param_2);
  ...
  uVar3 = FUN_0353ba6c(0x50);
  uVar4 = FUN_0353ba6c(6);
  uVar5 = FUN_0353ba6c(0x3c);
