// Class: ActivityCollectionPlantWars


/* ActivityCollectionPlantWars::ActivityCollectionPlantWars() */

void __thiscall
ActivityCollectionPlantWars::ActivityCollectionPlantWars(ActivityCollectionPlantWars *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662d5f0;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662d958;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662d9a0;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionPlantWars_0662d9c0;
  return;
}
...
/* non-virtual thunk to ActivityCollectionPlantWars::~ActivityCollectionPlantWars() */

void __thiscall
ActivityCollectionPlantWars::~ActivityCollectionPlantWars(ActivityCollectionPlantWars *this)

{
  ~ActivityCollectionPlantWars(this + -0xe8);
  return;
}
...
{
  ~ActivityCollectionPlantWars(this);
  AK::FreeHook(this);
  return;
}
...
/* ActivityCollectionPlantWars::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionPlantWars::InitContainer
          (ActivityCollectionPlantWars *this,ActivityCollectionTabBase *param_1)
...
/* non-virtual thunk to ActivityCollectionPlantWars::InitContainer(ActivityCollectionTabBase*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionPlantWars::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionPlantWars::Draw(ActivityCollectionPlantWars *this,Graphics *param_1)

{
  ...
  TodStringTranslate(L"[ACTIVITY_NFSLINKAGE_REASURE_SHORT_DESCRIPTION]");
