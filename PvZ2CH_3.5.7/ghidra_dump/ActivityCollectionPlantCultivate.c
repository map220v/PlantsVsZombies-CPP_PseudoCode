// Class: ActivityCollectionPlantCultivate


/* ActivityCollectionPlantCultivate::ActivityCollectionPlantCultivate() */

void __thiscall
ActivityCollectionPlantCultivate::ActivityCollectionPlantCultivate
          (ActivityCollectionPlantCultivate *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662b910;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662bc78;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662bcc0;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionPlantCultivate_0662bce0;
  return;
}
...
/* non-virtual thunk to ActivityCollectionPlantCultivate::~ActivityCollectionPlantCultivate() */
...
{
  ~ActivityCollectionPlantCultivate(this + -0xe8);
  return;
}
...
/* ActivityCollectionPlantCultivate::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionPlantCultivate::InitContainer
          (ActivityCollectionPlantCultivate *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a77);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_PLANTCULTIVATE");
  ...
  FUN_0342cf50(afStack_88);
  ActivityCollectionContainerBase::InitGotoButton
            ((ActivityCollectionContainerBase *)this,(TRect *)asStack_b8,(function *)afStack_88,
             false);
...
/* non-virtual thunk to ActivityCollectionPlantCultivate::InitContainer(ActivityCollectionTabBase*)
    */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionPlantCultivate::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionPlantCultivate::Draw(ActivityCollectionPlantCultivate *this,Graphics *param_1)

{
  ...
  TodStringTranslate(L"[PLANT_CULTIVATE_SHORT_DESCRIPTION]");
