// Class: ECommTableInserter


/* ECommTableInserter::~ECommTableInserter() */

void __thiscall ECommTableInserter::~ECommTableInserter(ECommTableInserter *this)

{
  *(undefined ***)this = &PTR__ECommTableInserter_067925d0;
...
/* ECommTableInserter::ECommTableInserter(Sexy::MetricsManager*, std::string const&, std::string
   const&, std::string const&) */

void __thiscall
ECommTableInserter::ECommTableInserter
          (ECommTableInserter *this,MetricsManager *param_1,string *param_2,string *param_3,
          string *param_4)

{
  ...
  std::string::string(asStack_18,"Ecomm");
  ...
  nop();
  ppuVar6 = &PTR__ECommTableInserter_067925d0;
  *(undefined ***)this = &PTR__ECommTableInserter_067925d0;
