// Class: AdRewardContent


/* AdRewardContent::~AdRewardContent() */

void __thiscall AdRewardContent::~AdRewardContent(AdRewardContent *this)

{
  *(undefined ***)this = &PTR_GetClass_066bd550;
...
{
  ~AdRewardContent(this);
  AK::FreeHook(this);
  return;
}


/* AdRewardContent::AdRewardContent(NDLoginRewardBonus const&) */

void __thiscall AdRewardContent::AdRewardContent(AdRewardContent *this,NDLoginRewardBonus *param_1)
...
/* AdRewardContent::Draw(Sexy::Graphics*) */

void __thiscall AdRewardContent::Draw(AdRewardContent *this,Graphics *param_1)

{
  ...
  if (cVar2 != '\0') {
    ...
    iVar4 = FUN_038e7764(0x28);
    iVar20 = FUN_038e7764(0x29);
    iVar6 = FUN_038e7764(0x2d);
    ...
    if (bVar3) {
      ...
      if (cVar2 != '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          pLVar14 = (LotteryResultProgressBar *)
                    CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06ab81f8);
          iVar6 = LotteryResultProgressBar::GetCurrentLevel(pLVar14);
          iVar20 = *(int *)(this + 0x54);
          ...
          uVar18 = PrimeText_PotentialTypeface::Typeface
                             (PrimeText_Game::Typeface_CafeteriaBlack_19_ThickOutline);
          iVar4 = FUN_038e7764(0x28);
          iVar6 = FUN_038e7764(0x29);
          iVar7 = FUN_038e7764(0x2d);
          FUN_05477b24(aCStack_50,auStack_58);
          Sexy::Color::Color(aCStack_40,1);
          Sexy::PrimeTypeface::DrawString_Line
...
LAB_038e837c:
  ...
  cVar2 = FUN_038e76e0(iVar4);
  if (cVar2 == '\0') {
    OtherServerNameMapper::GetInstance();
    cVar2 = FUN_038e76d0(iVar4);
    if (cVar2 == '\0') {
      OtherServerNameMapper::GetInstance();
      cVar2 = FUN_038e76f0(iVar4);
      if (cVar2 == '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          if (pLVar14 != (LotteryResultProgressBar *)0x0) {
            ...
            case 0:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06ab8328);
              break;
            case 1:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06ab8278);
            ...
            case 2:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06ab82c8);
              break;
            case 3:
            case 4:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06ab81b8);
              break;
            default:
              pIVar13 = (Image *)0x0;
            }
        ...
        if (cVar2 == '\0') {
          ...
          if (cVar2 != '\0') {
            ...
            pLVar14 = (LotteryResultProgressBar *)StringHelper::ToImage((string *)local_20,false);
            if (pLVar14 != (LotteryResultProgressBar *)0x0) {
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06ab8278);
              iVar4 = *(int *)(this + 0x50);
              ...
              iVar20 = SalesProgressBar::GetCurrentLevel((SalesProgressBar *)pLVar14);
              Sexy::Graphics::DrawImage
                        (param_1,(Image *)pLVar14,iVar6,iVar7,(int)(float)iVar4,(int)(float)iVar20);
              Sexy::StrFormat(L"x%d",asStack_60,(ulong)uVar1);
              uVar18 = PrimeText_PotentialTypeface::Typeface
                                 (PrimeText_Game::Typeface_CafeteriaBlack_19_ThickOutline);
              iVar4 = FUN_038e7764(0x19);
              iVar20 = FUN_038e7764(0x2d);
              FUN_05477b24(auStack_58,asStack_60);
              Sexy::Color::Color(aCStack_50,1);
              Sexy::PrimeTypeface::DrawString_Line
                        ((PrimeTypeface *)(float)(iVar4 * 2 + iVar6),(float)(iVar7 + iVar4 * 2),
                         (float)iVar20,uVar18,param_1,auStack_58,0,aCStack_50,0);
              FUN_05476c50(auStack_58);
              FUN_05476c50(asStack_60);
            }
            GAME_ITEM_INFO::~GAME_ITEM_INFO((GAME_ITEM_INFO *)aCStack_40);
          }
          goto LAB_038e8384;
        }
      ...
      if (cVar2 != '\0') {
        ...
        uVar18 = PrimeText_PotentialTypeface::Typeface
                           (PrimeText_Game::Typeface_CafeteriaBlack_19_ThickOutline);
        iVar4 = FUN_038e7764(0xc);
        iVar20 = FUN_038e7764(0x22);
        iVar6 = FUN_038e7764(0x2d);
        FUN_05477b24(aCStack_50,auStack_58);
        Sexy::Color::Color(aCStack_40,1);
        iVar4 = iVar4 + iVar5;
