// Class: UINewYearGiftBox


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UINewYearGiftBox::GetLayoutName() */

void __thiscall UINewYearGiftBox::GetLayoutName(UINewYearGiftBox *this)

{
  ...
  std::string::string(in_x8,"UINewYearGiftBox");
  nop();
...
/* UINewYearGiftBox::~UINewYearGiftBox() */

void __thiscall UINewYearGiftBox::~UINewYearGiftBox(UINewYearGiftBox *this)

{
  *(undefined ***)this = &PTR_GetClass_067aa470;
  *(undefined **)(this + 0xd8) = &DAT_067aa7c0;
  Sexy::WidgetContainer::RemoveAllWidgets((WidgetContainer *)this,true,true);
  MessageRouter::Unsubscribe((MessageRouter *)gMessageRouter,this);
  FUN_05476c50(this + 0x138);
  UISingletonDialog<UINewYearGiftBox>::~UISingletonDialog
            ((UISingletonDialog<UINewYearGiftBox> *)this);
  return;
}
...

{
  ...
  *(undefined8 *)(this + 0x170) = 0;
  this[0x144] = (UINewYearGiftBox)0x1;
  return;
}


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UINewYearGiftBox::Receive() */

void __thiscall UINewYearGiftBox::Receive(UINewYearGiftBox *this)

{
  ...
  std::string::string(asStack_68,"V743");
  FUN_03fc34fc(afStack_58,this);
  ...
  if ((*(long *)(this + 0x170) != 0) &&
     (lVar1 = *(long *)(this + 0x158), *(undefined1 *)(*(long *)(this + 0x170) + 0x110) = 1,
     lVar1 != 0)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UINewYearGiftBox::InitView() */

void __thiscall UINewYearGiftBox::InitView(UINewYearGiftBox *this)

{
  UIWidgetImage *pUVar1;
  NewYearGiftBoxInfoPage *this_00;
  PVZ2UIButton *pPVar2;
  long *plVar3;
  UIWidgetAnim *pUVar4;
  long lVar5;
  ...
  *(UIWidgetImage **)(this + 400) = pUVar1;
  ...
  NewYearGiftBoxInfoPage::NewYearGiftBoxInfoPage(this_00,*(UIWidgetImage **)(this + 400));
  *(NewYearGiftBoxInfoPage **)(this + 0x170) = this_00;
  lVar5 = *(long *)this;
  this_00[0x6d] = (NewYearGiftBoxInfoPage)0x0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UINewYearGiftBox::OnCreate() */

void __thiscall UINewYearGiftBox::OnCreate(UINewYearGiftBox *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UINewYearGiftBox::share() */

void __thiscall UINewYearGiftBox::share(UINewYearGiftBox *this)

{
  ...
  iVar2 = FUN_03fc35bc(0x23);
  iVar1 = *(int *)(pUVar4 + 0x4c);
  iVar3 = FUN_03fc35bc(10);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UINewYearGiftBox::ButtonDepress(int) */

void __thiscall UINewYearGiftBox::ButtonDepress(UINewYearGiftBox *this,int param_1)
...
/* non-virtual thunk to UINewYearGiftBox::ButtonDepress(int) */
