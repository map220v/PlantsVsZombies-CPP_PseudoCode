// Class: CypripediumPlantfood


/* CypripediumPlantfood::~CypripediumPlantfood() */

void __thiscall CypripediumPlantfood::~CypripediumPlantfood(CypripediumPlantfood *this)

{
  *(undefined ***)this = &PTR_GetClass_06820ab0;
  *(undefined ***)(this + 0x10) = &PTR__CypripediumPlantfood_06820ca0;
  Projectile::~Projectile((Projectile *)this);
  return;
}


/* non-virtual thunk to CypripediumPlantfood::~CypripediumPlantfood() */

void __thiscall CypripediumPlantfood::~CypripediumPlantfood(CypripediumPlantfood *this)

{
  ~CypripediumPlantfood(this + -0x10);
  return;
}
...
/* CypripediumPlantfood::StaticNew() */

CypripediumPlantfood * CypripediumPlantfood::StaticNew(void)
...
/* CypripediumPlantfood::StaticClassInit() */

void CypripediumPlantfood::StaticClassInit(void)

{
  ...
  if ((this != (CRefSymbolDb *)0x0) &&
    ...
    std::string::string(asStack_10,"CypripediumPlantfood");
    (*pcVar2)(plVar1,asStack_10,FUN_042728a0,0x1a8,0);
...
/* CypripediumPlantfood::StaticGetClass() */

long * CypripediumPlantfood::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"CypripediumPlantfood",uVar2,StaticNew);
  StaticClassInit();
  return sClass;
}


/* CypripediumPlantfood::GetClass() const */

long * CypripediumPlantfood::GetClass(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CypripediumPlantfood::OnCollideEntity(BoardEntity*) */

void __thiscall
CypripediumPlantfood::OnCollideEntity(CypripediumPlantfood *this,BoardEntity *param_1)

{
  ...
  if (param_1 != (BoardEntity *)0x0) {
    ...
    std::string::string((string *)local_30,"POPANIM_EFFECTS_CYPRIPEDIUM_PLANTFOOD");
