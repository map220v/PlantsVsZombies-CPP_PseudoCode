// Class: GeneEssenceMapper


/* GeneEssenceMapper::GetInstance() */

undefined1 * GeneEssenceMapper::GetInstance(void)

{
  ...
  if (((GetInstance()::instance & 1) == 0) &&
    ...
    GeneEssenceMapper((GeneEssenceMapper *)GetInstance()::instance);
    __cxa_guard_release(&GetInstance()::instance);
    __cxa_atexit(~GeneEssenceMapper,GetInstance()::instance,&DAT_06a88000);
...
/* GeneEssenceMapper::~GeneEssenceMapper() */

void __thiscall GeneEssenceMapper::~GeneEssenceMapper(GeneEssenceMapper *this)

{
  *(undefined ***)this = &PTR__GeneEssenceMapper_0669ce80;
