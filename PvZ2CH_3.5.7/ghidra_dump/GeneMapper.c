...
undefined1 * GeneMapper::GetInstance(void)

{
  ...
  if (((GetInstance()::instance & 1) == 0) &&
    ...
    GeneMapper((GeneMapper *)GetInstance()::instance);
    __cxa_guard_release(&GetInstance()::instance);
    __cxa_atexit(~GeneMapper,GetInstance()::instance,&DAT_06a88000);
...
void __thiscall GeneMapper::~GeneMapper(GeneMapper *this)

{
  *(undefined ***)this = &PTR__GeneMapper_0669ce60;
