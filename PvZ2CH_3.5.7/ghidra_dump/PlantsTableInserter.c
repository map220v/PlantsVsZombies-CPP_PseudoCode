// Class: PlantsTableInserter


/* PlantsTableInserter::~PlantsTableInserter() */

void __thiscall PlantsTableInserter::~PlantsTableInserter(PlantsTableInserter *this)

{
  *(undefined ***)this = &PTR__PlantsTableInserter_06792650;
...
/* PlantsTableInserter::PlantsTableInserter(Sexy::MetricsManager*, std::string const&, std::string
   const&, std::string const&) */

void __thiscall
PlantsTableInserter::PlantsTableInserter
          (PlantsTableInserter *this,MetricsManager *param_1,string *param_2,string *param_3,
          string *param_4)

{
  ...
  nop();
  ppuVar6 = &PTR__PlantsTableInserter_06792650;
  *(undefined ***)this = &PTR__PlantsTableInserter_06792650;
