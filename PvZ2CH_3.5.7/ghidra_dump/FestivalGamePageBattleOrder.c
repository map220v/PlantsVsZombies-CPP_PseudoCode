// Class: FestivalGamePageBattleOrder


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FestivalGamePageBattleOrder::GetLayoutName() */

void __thiscall FestivalGamePageBattleOrder::GetLayoutName(FestivalGamePageBattleOrder *this)

{
  ...
  std::string::string(in_x8,"FestivalGamePageBattleOrder");
  nop();
...
/* FestivalGamePageBattleOrder::~FestivalGamePageBattleOrder() */

void __thiscall
FestivalGamePageBattleOrder::~FestivalGamePageBattleOrder(FestivalGamePageBattleOrder *this)

{
  *(undefined ***)this = &PTR_GetClass_06720e80;
  *(undefined **)(this + 0xd8) = &DAT_067211d0;
...
{
  ~FestivalGamePageBattleOrder(this);
  AK::FreeHook(this);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FestivalGamePageBattleOrder::Update() */

void __thiscall FestivalGamePageBattleOrder::Update(FestivalGamePageBattleOrder *this)
...

{
  ...
  UISingletonDialog<FestivalGamePageBattleOrder>::UISingletonDialog
            ((UISingletonDialog<FestivalGamePageBattleOrder> *)this);
  this[0x131] = (FestivalGamePageBattleOrder)0x0;
  *(undefined ***)this = &PTR_GetClass_06720e80;
  *(undefined **)(this + 0xd8) = &DAT_067211d0;
  ...
  uStack_38 = uStack_10;
  MessageRouter::
  Subscribe<bool,std::set<int,std::less<int>,std::allocator<int>>const&,Sexy::CBMemberTranslatorX<FestivalGamePageBattleOrder,void(FestivalGamePageBattleOrder::*)(bool,std::set<int,std::less<int>,std::allocator<int>>const&)>>
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FestivalGamePageBattleOrder::onNotifyRefreshActivityList(bool, std::set<int, std::less<int>,
   std::allocator<int> > const&) */

void __thiscall
FestivalGamePageBattleOrder::onNotifyRefreshActivityList
          (FestivalGamePageBattleOrder *this,bool param_1,set *param_2)

{
  ...
  local_8 = ___stack_chk_guard;
  if ((param_1) && (this[0x131] != (FestivalGamePageBattleOrder)0x0)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FestivalGamePageBattleOrder::ButtonDepress(int) */

void __thiscall
FestivalGamePageBattleOrder::ButtonDepress(FestivalGamePageBattleOrder *this,int param_1)

{
  ...
  if (param_1 == 0x1f8) {
    ...
    if ((cVar1 == '\0') || (local_70 == '\0')) {
      ...
      this[0x131] = (FestivalGamePageBattleOrder)0x1;
...
/* non-virtual thunk to FestivalGamePageBattleOrder::ButtonDepress(int) */
