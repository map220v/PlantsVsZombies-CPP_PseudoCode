// Class: SteamManholeChallenge


/* SteamManholeChallenge::gameplayEnded() */

void __thiscall SteamManholeChallenge::gameplayEnded(SteamManholeChallenge *this)
...
void SteamManholeChallenge::StaticClassInit(void)

{
  ...
  if ((this != (CRefSymbolDb *)0x0) &&
    ...
    std::string::string(asStack_10,"SteamManholeChallenge");
    (*pcVar2)(plVar1,asStack_10,FUN_03684d48,0x30,0);
...
/* SteamManholeChallenge::StaticGetClass() */

long * SteamManholeChallenge::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"SteamManholeChallenge",uVar2,StaticNew);
  StaticClassInit();
  return sClass;
}


/* SteamManholeChallenge::~SteamManholeChallenge() */

void __thiscall SteamManholeChallenge::~SteamManholeChallenge(SteamManholeChallenge *this)

{
  *(undefined ***)this = &PTR_GetModuleClass_0667b100;
...
/* SteamManholeChallenge::StaticNew() */

SteamManholeChallenge * SteamManholeChallenge::StaticNew(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* SteamManholeChallenge::onNotifyEnterManhole() */

void __thiscall SteamManholeChallenge::onNotifyEnterManhole(SteamManholeChallenge *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* SteamManholeChallenge::gameplayStarted() */

void __thiscall SteamManholeChallenge::gameplayStarted(SteamManholeChallenge *this)

{
  ...
  Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get((RtWeakPtr<Sexy::ResourceInfo> *)this_00);
  nop();
  CachedUIResourcePtr::operator_cast_to_RtWeakPtr((CachedUIResourcePtr *)&DAT_06aab138);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* SteamManholeChallenge::registerForEvents() */

void __thiscall SteamManholeChallenge::registerForEvents(SteamManholeChallenge *this)

{
  ...
  Sexy::
  MakeDelegate<Sexy::AndroidHttpTransaction::ReceivedDataCallback,void(Sexy::AndroidHttpTransaction::ReceivedDataCallback::*)()>
            ((ReceivedDataCallback *)this,onNotifyEnterManhole);
  Sexy::Delegate0::Delegate0<SteamManholeChallenge,void(SteamManholeChallenge::*)()>
            (aDStack_38,aCStack_50);
  MessageRouter::Subscribe((MessageRouter *)this_00,Message::NotifyEnterManhole,aDStack_38);
  if (local_8 == ___stack_chk_guard) {
    return;
  }
                    /* WARNING: Subroutine does not return */
