// Class: ActivityCollectionUITenYearRecord


/* ActivityCollectionUITenYearRecord::ActivityCollectionUITenYearRecord() */

void __thiscall
ActivityCollectionUITenYearRecord::ActivityCollectionUITenYearRecord
          (ActivityCollectionUITenYearRecord *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662f1e0;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662f548;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662f590;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionUITenYearRecord_0662f5b0;
  return;
}
...
/* non-virtual thunk to ActivityCollectionUITenYearRecord::~ActivityCollectionUITenYearRecord() */
...
{
  ~ActivityCollectionUITenYearRecord(this + -0xe8);
  return;
}
...
/* ActivityCollectionUITenYearRecord::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionUITenYearRecord::InitContainer
          (ActivityCollectionUITenYearRecord *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a75);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_TENYEARRECORD");
  UIRewardFrame::SetDecoratorString((UIRewardFrame *)this,asStack_b8);
  std::string::~string(asStack_b8);
  nop();
  iVar2 = FUN_0342d430(300);
  iVar6 = *(int *)(this + 0x50);
  iVar3 = FUN_0342d430(0x10e);
...
/* non-virtual thunk to ActivityCollectionUITenYearRecord::InitContainer(ActivityCollectionTabBase*)
    */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionUITenYearRecord::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionUITenYearRecord::Draw(ActivityCollectionUITenYearRecord *this,Graphics *param_1)

{
  ...
  pIVar8 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa05b0);
  iVar4 = FUN_0342d430(0xd2);
  ...
  Sexy::Graphics::DrawImage(param_1,pIVar8,iVar2,iVar4 - iVar3,iVar5,iVar6);
  TodStringTranslate(L"[POSSIBLE_REWARDSONE]");
