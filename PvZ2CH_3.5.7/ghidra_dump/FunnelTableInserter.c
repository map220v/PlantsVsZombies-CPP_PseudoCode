// Class: FunnelTableInserter


/* FunnelTableInserter::~FunnelTableInserter() */

void __thiscall FunnelTableInserter::~FunnelTableInserter(FunnelTableInserter *this)

{
  *(undefined ***)this = &PTR__FunnelTableInserter_06792690;
...
/* FunnelTableInserter::FunnelTableInserter(Sexy::MetricsManager*, std::string const&, std::string
   const&, std::string const&) */

void __thiscall
FunnelTableInserter::FunnelTableInserter
          (FunnelTableInserter *this,MetricsManager *param_1,string *param_2,string *param_3,
          string *param_4)

{
  ...
  std::string::string(asStack_18,"Funnel");
  ...
  nop();
  ppuVar6 = &PTR__FunnelTableInserter_06792690;
  *(undefined ***)this = &PTR__FunnelTableInserter_06792690;
