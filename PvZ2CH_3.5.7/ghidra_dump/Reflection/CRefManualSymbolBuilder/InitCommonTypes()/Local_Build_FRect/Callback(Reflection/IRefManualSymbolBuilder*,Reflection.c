// Class: Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_FRect::Callback(Reflection::IRefManualSymbolBuilder*,Reflection


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_FRect::Callback(Reflection::IRefManualSymbolBuilder*,
   Reflection::RClass*) */

void Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_FRect::Callback(Reflection
...

{
  ...
  *p_Var4;
  ...
  std::string::string(asStack_30,"float");
  uVar3 = thunk_FUN_0517eca4(param_1);
