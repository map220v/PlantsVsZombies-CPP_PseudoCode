// Class: Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_Rect::Callback(Reflection::IRefManualSymbolBuilder*,Reflection


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_Rect::Callback(Reflection::IRefManualSymbolBuilder*,
   Reflection::RClass*) */

void Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_Rect::Callback(Reflection::
...

{
  ...
  *p_Var4;
  ...
  std::string::~string(asStack_30);
  nop();
  std::string::string(asStack_30,"PropGrid.LinkedAxisY");
  pcVar5 = *(code **)(*param_1 + 0x78);
  std::string::string(asStack_38,"PropGrid.LinkedAxisY");
  CRefAttributeVariant::CRefAttributeVariant(aCStack_28,"mY");
  pRVar2 = (RAncestor *)(*pcVar5)(param_1,asStack_38,aCStack_28);
  TRefNamedSymbolCollection<Reflection::RAncestor>::AddSymbol(pTVar1,asStack_30,pRVar2);
  CRefAttributeVariant::~CRefAttributeVariant(aCStack_28);
  std::string::~string(asStack_38);
  ...
  std::string::~string(asStack_30);
  nop();
  std::string::string(asStack_30,"PropGrid.LinkedAxisX");
  pcVar5 = *(code **)(*param_1 + 0x78);
  std::string::string(asStack_38,"PropGrid.LinkedAxisX");
  CRefAttributeVariant::CRefAttributeVariant(aCStack_28,"mX");
  pRVar2 = (RAncestor *)(*pcVar5)(param_1,asStack_38,aCStack_28);
  TRefNamedSymbolCollection<Reflection::RAncestor>::AddSymbol(pTVar1,asStack_30,pRVar2);
  CRefAttributeVariant::~CRefAttributeVariant(aCStack_28);
  std::string::~string(asStack_38);
  ...
  nop();
  pcVar5 = *(code **)(*param_1 + 0x58);
  std::string::string((string *)aCStack_28,"mWidth");
  std::string::string(asStack_30,"int");
  uVar3 = thunk_FUN_0517ec80(param_1);
  p_Var4 = (_Rb_tree<int,std::pair<int_const,Sexy::TypedKey<Sexy::Color>>,std::_Select1st<std::pair<int_const,Sexy::TypedKey<Sexy::Color>>>,std::less<int>,std::allocator<std::pair<int_const,Sexy::TypedKey<Sexy::Color>>>>
  ...
  pcVar5 = *(code **)(*param_1 + 0x78);
  std::string::string(asStack_38,"DisplayName");
  CRefAttributeVariant::CRefAttributeVariant(aCStack_28,"W");
  pRVar2 = (RAncestor *)(*pcVar5)(param_1,asStack_38,aCStack_28);
  TRefNamedSymbolCollection<Reflection::RAncestor>::AddSymbol(pTVar1,asStack_30,pRVar2);
  CRefAttributeVariant::~CRefAttributeVariant(aCStack_28);
  std::string::~string(asStack_38);
  ...
  pcVar5 = *(code **)(*param_1 + 0x78);
  std::string::string(asStack_38,"PropGrid.LinkedAxisY");
  CRefAttributeVariant::CRefAttributeVariant(aCStack_28,"mHeight");
  pRVar2 = (RAncestor *)(*pcVar5)(param_1,asStack_38,aCStack_28);
  TRefNamedSymbolCollection<Reflection::RAncestor>::AddSymbol(pTVar1,asStack_30,pRVar2);
  CRefAttributeVariant::~CRefAttributeVariant(aCStack_28);
  std::string::~string(asStack_38);
  ...
  nop();
  pcVar5 = *(code **)(*param_1 + 0x58);
  std::string::string((string *)aCStack_28,"mHeight");
  std::string::string(asStack_30,"int");
  uVar3 = thunk_FUN_0517ec80(param_1);
  p_Var4 = (_Rb_tree<int,std::pair<int_const,Sexy::TypedKey<Sexy::Color>>,std::_Select1st<std::pair<int_const,Sexy::TypedKey<Sexy::Color>>>,std::less<int>,std::allocator<std::pair<int_const,Sexy::TypedKey<Sexy::Color>>>>
  ...
  pcVar5 = *(code **)(*param_1 + 0x78);
  std::string::string(asStack_38,"DisplayName");
  CRefAttributeVariant::CRefAttributeVariant(aCStack_28,"H");
  pRVar2 = (RAncestor *)(*pcVar5)(param_1,asStack_38,aCStack_28);
  TRefNamedSymbolCollection<Reflection::RAncestor>::AddSymbol(pTVar1,asStack_30,pRVar2);
  CRefAttributeVariant::~CRefAttributeVariant(aCStack_28);
  std::string::~string(asStack_38);
  ...
  pcVar5 = *(code **)(*param_1 + 0x78);
  std::string::string(asStack_38,"PropGrid.LinkedAxisX");
  CRefAttributeVariant::CRefAttributeVariant(aCStack_28,"mWidth");
  pRVar2 = (RAncestor *)(*pcVar5)(param_1,asStack_38,aCStack_28);
  TRefNamedSymbolCollection<Reflection::RAncestor>::AddSymbol(pTVar1,asStack_30,pRVar2);
  CRefAttributeVariant::~CRefAttributeVariant(aCStack_28);
  std::string::~string(asStack_38);
