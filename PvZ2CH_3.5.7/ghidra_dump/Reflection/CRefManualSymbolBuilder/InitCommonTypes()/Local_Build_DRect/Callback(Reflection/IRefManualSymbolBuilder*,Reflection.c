// Class: Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_DRect::Callback(Reflection::IRefManualSymbolBuilder*,Reflection


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_DRect::Callback(Reflection::IRefManualSymbolBuilder*,
   Reflection::RClass*) */

void Reflection::CRefManualSymbolBuilder::InitCommonTypes()::Local_Build_DRect::Callback(Reflection
...

{
  ...
  *p_Var4;
  ...
  uVar3 = thunk_FUN_0517ecc8(param_1);
  p_Var4 = (_Rb_tree<int,std::pair<int_const,Sexy::TypedKey<Sexy::Color>>,std::_Select1st<std::pair<int_const,Sexy::TypedKey<Sexy::Color>>>,std::less<int>,std::allocator<std::pair<int_const,Sexy::TypedKey<Sexy::Color>>>>
            *)(*pcVar5)(param_1,param_2,aCStack_28,0x10,uVar3);
  std::string::~string(asStack_30);
  nop();
  std::string::~string((string *)aCStack_28);
  nop();
  ...
  uVar3 = thunk_FUN_0517ecc8(param_1);
  p_Var4 = (_Rb_tree<int,std::pair<int_const,Sexy::TypedKey<Sexy::Color>>,std::_Select1st<std::pair<int_const,Sexy::TypedKey<Sexy::Color>>>,std::less<int>,std::allocator<std::pair<int_const,Sexy::TypedKey<Sexy::Color>>>>
            *)(*pcVar5)(param_1,param_2,aCStack_28,0x18,uVar3);
  std::string::~string(asStack_30);
  nop();
  std::string::~string((string *)aCStack_28);
  nop();
