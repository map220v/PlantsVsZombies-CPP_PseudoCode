// Class: MiniGameRankRewardContent


/* MiniGameRankRewardContent::~MiniGameRankRewardContent() */

void __thiscall
MiniGameRankRewardContent::~MiniGameRankRewardContent(MiniGameRankRewardContent *this)

{
  *(undefined ***)this = &PTR_GetClass_066ccce0;
...
{
  ~MiniGameRankRewardContent(this);
  AK::FreeHook(this);
  return;
}


/* MiniGameRankRewardContent::MiniGameRankRewardContent(NDLoginRewardBonus const&) */

void __thiscall
MiniGameRankRewardContent::MiniGameRankRewardContent
          (MiniGameRankRewardContent *this,NDLoginRewardBonus *param_1)
...
/* MiniGameRankRewardContent::Draw(Sexy::Graphics*) */

void __thiscall MiniGameRankRewardContent::Draw(MiniGameRankRewardContent *this,Graphics *param_1)

{
  ...
  if (cVar2 != '\0') {
    ...
    iVar4 = FUN_0393b0c8(0x28);
    iVar20 = FUN_0393b0c8(0x29);
    iVar6 = FUN_0393b0c8(0x2d);
    ...
    if (bVar3) {
      ...
      if (cVar2 != '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          pLVar14 = (LotteryResultProgressBar *)
                    CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06abb858);
          iVar6 = LotteryResultProgressBar::GetCurrentLevel(pLVar14);
          iVar20 = *(int *)(this + 0x54);
          ...
          ;
          iVar4 = FUN_0393b0c8(0x28);
          iVar6 = FUN_0393b0c8(0x29);
          iVar7 = FUN_0393b0c8(0x2d);
          FUN_05477b24(aCStack_50,auStack_58);
          Sexy::Color::Color(aCStack_40,1);
          Sexy::PrimeTypeface::DrawString_Line
...
LAB_0393cd94:
  ...
  if (cVar2 != '\0') {
    ...
    if (bVar3) {
      ...
      if (cVar2 != '\0') {
        ...
        pLVar14 = (LotteryResultProgressBar *)
                  CachedUIResourcePtr<Sexy::Image>::operator->
                            ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06abb7d8);
        iVar6 = LotteryResultProgressBar::GetCurrentLevel(pLVar14);
        iVar20 = *(int *)(this + 0x54);
        pSVar15 = (SalesProgressBar *)
                  CachedUIResourcePtr<Sexy::Image>::operator->
  ...
  cVar2 = FUN_0393a7e8(iVar4);
  if (cVar2 == '\0') {
    OtherServerNameMapper::GetInstance();
    cVar2 = FUN_0393a7d8(iVar4);
    if (cVar2 == '\0') {
      OtherServerNameMapper::GetInstance();
      cVar2 = FUN_0393a7f8(iVar4);
      if (cVar2 == '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          if (pLVar14 != (LotteryResultProgressBar *)0x0) {
            ...
            case 0:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06abb8d0);
              break;
            case 1:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06abb948);
            ...
            case 2:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06abb918);
              break;
            case 3:
            case 4:
              pIVar13 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                                           ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06abb800);
              break;
            default:
              pIVar13 = (Image *)0x0;
            }
        ...
        pNVar9 = (NameMapperBase *)MaterialItemMapper::GetInstance();
        cVar2 = NameMapperBase::ContainsId(pNVar9,iVar4);
        if (cVar2 == '\0') goto LAB_0393cd9c;
        std::string::string((string *)aCStack_40,"IMAGE_UI_HUD_WORLDMAP_MINIGAME_ICON");
        ...
        if (cVar2 != '\0') {
          ...
          iVar6 = LotteryResultProgressBar::GetCurrentLevel(pLVar14);
          iVar20 = *(int *)(this + 0x54);
          iVar6 = (int)(((float)iVar4 - (float)iVar6) * 0.5);
          pSVar15 = (SalesProgressBar *)
                    Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get
                              ((RtWeakPtr<Sexy::ResourceInfo> *)asStack_60);
          iVar4 = SalesProgressBar::GetCurrentLevel(pSVar15);
          iVar7 = (int)(((float)iVar20 - (float)iVar4) * 0.5);
          pLVar14 = (LotteryResultProgressBar *)
                    Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get
                              ((RtWeakPtr<Sexy::ResourceInfo> *)asStack_60);
          iVar4 = LotteryResultProgressBar::GetCurrentLevel(pLVar14);
          ...
          pIVar13 = (Image *)Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get
                                       ((RtWeakPtr<Sexy::ResourceInfo> *)asStack_60);
          Sexy::Graphics::DrawImage
                    (param_1,pIVar13,iVar6,iVar7,(int)(float)iVar4,(int)(float)iVar20);
          Sexy::StrFormat(L"x%d",auStack_58,(ulong)uVar1);
          uVar18 = PrimeText_PotentialTypeface::Typeface(PrimeText_Game::Typeface_CafeteriaBlack_20)
          ;
          iVar4 = FUN_0393b0c8(0x19);
          iVar20 = FUN_0393b0c8(0x2d);
          FUN_05477b24(aCStack_50,auStack_58);
          Sexy::Color::Color(aCStack_40,1);
          Sexy::PrimeTypeface::DrawString_Line
                    ((PrimeTypeface *)(float)(iVar4 + iVar6),(float)(iVar7 + iVar4),(float)iVar20,
                     uVar18,param_1,aCStack_50,0,(string *)aCStack_40,0);
          FUN_05476c50(aCStack_50);
          FUN_05476c50(auStack_58);
        }
      }
        ...
        if (cVar2 != '\0') {
          ...
          pIVar13 = (Image *)Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get
                                       ((RtWeakPtr<Sexy::ResourceInfo> *)asStack_60);
          Sexy::Graphics::DrawImage
                    (param_1,pIVar13,iVar5,iVar7,(int)((float)iVar4 * 0.6),
                     (int)((float)iVar20 * 0.6));
          Sexy::StrFormat(L"x%d",auStack_58,(ulong)uVar1);
          uVar18 = PrimeText_PotentialTypeface::Typeface(PrimeText_Game::Typeface_CafeteriaBlack_20)
          ;
      ...
      if (cVar2 != '\0') {
        ...
        Sexy::StrFormat(L"x%d",auStack_58,(ulong)uVar1);
        uVar18 = PrimeText_PotentialTypeface::Typeface(PrimeText_Game::Typeface_CafeteriaBlack_20);
        iVar4 = FUN_0393b0c8(0xc);
        iVar20 = FUN_0393b0c8(0x22);
        iVar6 = FUN_0393b0c8(0x2d);
        FUN_05477b24(aCStack_50,auStack_58);
        Sexy::Color::Color(aCStack_40,1);
        iVar4 = iVar4 + iVar5;
