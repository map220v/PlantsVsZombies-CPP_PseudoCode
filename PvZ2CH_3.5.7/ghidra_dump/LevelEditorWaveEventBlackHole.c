// Class: LevelEditorWaveEventBlackHole


/* LevelEditorWaveEventBlackHole::~LevelEditorWaveEventBlackHole() */

void __thiscall
LevelEditorWaveEventBlackHole::~LevelEditorWaveEventBlackHole(LevelEditorWaveEventBlackHole *this)

{
  *(undefined ***)this = &PTR_GetClass_06969710;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_06969a38;
...
{
  ~LevelEditorWaveEventBlackHole(this);
  AK::FreeHook(this);
  return;
}
...
/* LevelEditorWaveEventBlackHole::ButtonDepress(int) */

void __thiscall
LevelEditorWaveEventBlackHole::ButtonDepress(LevelEditorWaveEventBlackHole *this,int param_1)

{
  ...
  if (param_1 == 0x7e6) {
    uVar1 = ClampInt(*(int *)(this + 0xf4) + -1,1,7);
    *(undefined4 *)(this + 0xf4) = uVar1;
    pCVar2 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
    CustomLevelMgr::SetBlackHoleColumnEnd(pCVar2,*(int *)(this + 0xf0),*(int *)(this + 0xf4));
    return;
  }
  if (param_1 == 0x7e7) {
    uVar1 = ClampInt(*(int *)(this + 0xf4) + 1,1,7);
...
/* non-virtual thunk to LevelEditorWaveEventBlackHole::ButtonDepress(int) */
...
/* LevelEditorWaveEventBlackHole::Reload() */

void __thiscall LevelEditorWaveEventBlackHole::Reload(LevelEditorWaveEventBlackHole *this)

{
  ...
  iVar2 = CustomLevelMgr::GetBlackHoleColumnEnd(pCVar1,*(int *)(this + 0xf0));
  uVar3 = ClampInt(iVar2,1,7);
  *(undefined4 *)(this + 0xf4) = uVar3;
  pCVar1 = (CustomLevelMgr *)Sexy::LazySingleton<CustomLevelMgr>::GetInstancePtr();
  CustomLevelMgr::SetBlackHoleColumnEnd(pCVar1,*(int *)(this + 0xf0),*(int *)(this + 0xf4));
  return;
}


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LevelEditorWaveEventBlackHole::Init(int) */

void __thiscall LevelEditorWaveEventBlackHole::Init(LevelEditorWaveEventBlackHole *this,int param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LevelEditorWaveEventBlackHole::Draw(Sexy::Graphics*) */

void __thiscall
LevelEditorWaveEventBlackHole::Draw(LevelEditorWaveEventBlackHole *this,Graphics *param_1)

{
  ...
  TodStringTranslate(L"[LEVEL_EDITOR_WAVE_EVENT_BLACK_HOLE_TITLE]");
  ...
  TodStringTranslate(L"[LEVEL_EDITOR_WAVE_EVENT_BLACK_HOLE_BTN_LEFT]");
  iVar1 = FUN_04b54f08(0x32);
