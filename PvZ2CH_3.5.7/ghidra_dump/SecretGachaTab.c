// Class: SecretGachaTab


/* SecretGachaTab::~SecretGachaTab() */

void __thiscall SecretGachaTab::~SecretGachaTab(SecretGachaTab *this)

{
  *(undefined ***)this = &PTR__SecretGachaTab_0671e9d0;
  YuanBaoEventTab::~YuanBaoEventTab((YuanBaoEventTab *)this);
  return;
}


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* SecretGachaTab::GetTabContainerImageName() const */

void __thiscall SecretGachaTab::GetTabContainerImageName(SecretGachaTab *this)

{
  ...
  std::string::string(in_x8,"IMAGE_UI_FESTIVALCENTER_SECRET_GACHA_EVENT");
  nop();
...
/* SecretGachaTab::SecretGachaTab(int, UI::Dialog*) */

void __thiscall SecretGachaTab::SecretGachaTab(SecretGachaTab *this,int param_1,Dialog *param_2)

{
  YuanBaoEventTab::YuanBaoEventTab((YuanBaoEventTab *)this,param_1,param_2);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* SecretGachaTab::DrawForeground(Sexy::Graphics*) */

void __thiscall SecretGachaTab::DrawForeground(SecretGachaTab *this,Graphics *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* SecretGachaTab::SyncActivityData(int) */

void SecretGachaTab::SyncActivityData(int param_1)

{
  ...
  if (cVar1 != '\0') {
    *(undefined8 *)((ulong)(uint)param_1 + 0x28) = local_38;
  }
