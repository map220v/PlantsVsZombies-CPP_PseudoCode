// Class: UIAnniversaryInfoButton


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UIAnniversaryInfoButton::Draw(Sexy::Graphics*) */

void __thiscall UIAnniversaryInfoButton::Draw(UIAnniversaryInfoButton *this,Graphics *param_1)

{
  ...
  if (cVar1 != '\0') {
    ...
    if ((cVar1 != '\0') || (this[0x1a8] != (UIAnniversaryInfoButton)0x0)) {
    ...
    if ((bVar2) && (this[0x1a8] == (UIAnniversaryInfoButton)0x0)) {
      Sexy::Color::Color(aCStack_18,1);
...
/* non-virtual thunk to UIAnniversaryInfoButton::Draw(Sexy::Graphics*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UIAnniversaryInfoButton::StaticClassInit() */

void UIAnniversaryInfoButton::StaticClassInit(void)

{
  ...
  if ((this != (CRefSymbolDb *)0x0) &&
    ...
    std::string::string(asStack_10,"UIAnniversaryInfoButton");
    (*pcVar2)(plVar1,asStack_10,FUN_045696f0,0x1d0,0);
...
/* UIAnniversaryInfoButton::StaticGetClass() */

long * UIAnniversaryInfoButton::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"UIAnniversaryInfoButton",uVar2,StaticNew);
  StaticClassInit();
  return sClass;
}


/* UIAnniversaryInfoButton::GetClass() const */

long * UIAnniversaryInfoButton::GetClass(void)
...
/* UIAnniversaryInfoButton::~UIAnniversaryInfoButton() */

void __thiscall UIAnniversaryInfoButton::~UIAnniversaryInfoButton(UIAnniversaryInfoButton *this)

{
  *(undefined ***)this = &PTR_GetClass_0685c140;
  *(undefined ***)(this + 0x10) = &PTR__UIAnniversaryInfoButton_0685c2f0;
  UIEasyButtonWidget::~UIEasyButtonWidget((UIEasyButtonWidget *)this);
  return;
}


/* non-virtual thunk to UIAnniversaryInfoButton::~UIAnniversaryInfoButton() */

void __thiscall UIAnniversaryInfoButton::~UIAnniversaryInfoButton(UIAnniversaryInfoButton *this)

{
  ~UIAnniversaryInfoButton(this + -0x10);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UIAnniversaryInfoButton::OnClick() */

void UIAnniversaryInfoButton::OnClick(void)
...
/* UIAnniversaryInfoButton::StaticNew() */

UIAnniversaryInfoButton * UIAnniversaryInfoButton::StaticNew(void)
