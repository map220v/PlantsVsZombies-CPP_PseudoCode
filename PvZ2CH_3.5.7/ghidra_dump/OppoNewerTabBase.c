...
/* OppoNewerTabBase::Update() */

void OppoNewerTabBase::Update(void)
...
/* OppoNewerTabBase::SetSelect(bool) */

void __thiscall OppoNewerTabBase::SetSelect(OppoNewerTabBase *this,bool param_1)

{
  ...
  if ((pPVar5 != (PVZ2UIButton *)0x0) && (*(long *)(this + 0x10) != 0)) {
    cVar1 = FUN_038ff214(pPVar5[0x1a8]);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OppoNewerTabBase::OppoNewerTabBase(int, UI::Dialog*) */

void __thiscall
OppoNewerTabBase::OppoNewerTabBase(OppoNewerTabBase *this,int param_1,Dialog *param_2)

{
  ...
  *(int *)(this + 8) = param_1;
  local_8 = ___stack_chk_guard;
  *(undefined ***)this = &PTR_nop_066bf690;
