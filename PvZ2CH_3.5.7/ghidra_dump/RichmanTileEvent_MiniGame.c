// Class: RichmanTileEvent_MiniGame


/* RichmanTileEvent_MiniGame::PostEventMessage() */

void RichmanTileEvent_MiniGame::PostEventMessage(void)
...
/* RichmanTileEvent_MiniGame::ShowEntryUI() */

void __thiscall RichmanTileEvent_MiniGame::ShowEntryUI(RichmanTileEvent_MiniGame *this)
...
/* RichmanTileEvent_MiniGame::ExecuteEvent() */

void __thiscall RichmanTileEvent_MiniGame::ExecuteEvent(RichmanTileEvent_MiniGame *this)
...
/* RichmanTileEvent_MiniGame::ExecuteEventPost() */

void RichmanTileEvent_MiniGame::ExecuteEventPost(void)
...
/* RichmanTileEvent_MiniGame::OnEscapeBtn() */

void RichmanTileEvent_MiniGame::OnEscapeBtn(void)
...
/* RichmanTileEvent_MiniGame::OnEnterBtn() */

void __thiscall RichmanTileEvent_MiniGame::OnEnterBtn(RichmanTileEvent_MiniGame *this)
...
void __thiscall
RichmanTileEvent_MiniGame::~RichmanTileEvent_MiniGame(RichmanTileEvent_MiniGame *this)

{
  *(undefined ***)this = &PTR__RichmanTileEvent_MiniGame_06987f40;
...
{
  ~RichmanTileEvent_MiniGame(this);
  AK::FreeHook(this);
  return;
}


/* RichmanTileEvent_MiniGame::RichmanTileEvent_MiniGame(RichmanTileEventConfig&) */

void __thiscall
RichmanTileEvent_MiniGame::RichmanTileEvent_MiniGame
          (RichmanTileEvent_MiniGame *this,RichmanTileEventConfig *param_1)
