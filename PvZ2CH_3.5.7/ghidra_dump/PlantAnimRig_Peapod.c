// Class: PlantAnimRig_Peapod


/* PlantAnimRig_Peapod::~PlantAnimRig_Peapod() */

void __thiscall PlantAnimRig_Peapod::~PlantAnimRig_Peapod(PlantAnimRig_Peapod *this)

{
  *(undefined ***)this = &PTR_GetClass_0679c520;
  *(undefined ***)(this + 0x10) = &PTR__PlantAnimRig_Peapod_0679c788;
...
/* non-virtual thunk to PlantAnimRig_Peapod::~PlantAnimRig_Peapod() */

void __thiscall PlantAnimRig_Peapod::~PlantAnimRig_Peapod(PlantAnimRig_Peapod *this)

{
  ~PlantAnimRig_Peapod(this + -0x10);
  return;
}
...
/* PlantAnimRig_Peapod::StaticClassInit() */

void PlantAnimRig_Peapod::StaticClassInit(void)

{
  ...
  if ((this != (CRefSymbolDb *)0x0) &&
    ...
    std::string::string(asStack_10,"PlantAnimRig_Peapod");
    (*pcVar2)(plVar1,asStack_10,FUN_03f5be1c,0x408,0);
...
/* PlantAnimRig_Peapod::StaticGetClass() */

long * PlantAnimRig_Peapod::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"PlantAnimRig_Peapod",uVar2,StaticNew);
  StaticClassInit();
  return sClass;
}


/* PlantAnimRig_Peapod::GetClass() const */

long * PlantAnimRig_Peapod::GetClass(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* PlantAnimRig_Peapod::PlayAttack(RtReflectionDelegate<Sexy::Delegate1<std::string const&> >) */

void __thiscall
PlantAnimRig_Peapod::PlayAttack(PlantAnimRig_Peapod *this,RtReflectionDelegate *param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* PlantAnimRig_Peapod::SetLevel(int) */

void __thiscall PlantAnimRig_Peapod::SetLevel(PlantAnimRig_Peapod *this,int param_1)

{
  ...
  *(int *)(this + 0x3b8) = param_1;
  local_8 = ___stack_chk_guard;
  lVar2 = FUN_03f5b860(*(undefined8 *)(this + 0x20));
...
/* PlantAnimRig_Peapod::StaticNew() */

PlantAnimRig_Peapod * PlantAnimRig_Peapod::StaticNew(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* PlantAnimRig_Peapod::PlayIdleLooped() */

void __thiscall PlantAnimRig_Peapod::PlayIdleLooped(PlantAnimRig_Peapod *this)
