// Class: ViralTableInserter


/* ViralTableInserter::~ViralTableInserter() */

void __thiscall ViralTableInserter::~ViralTableInserter(ViralTableInserter *this)

{
  *(undefined ***)this = &PTR__ViralTableInserter_067926b0;
...
/* ViralTableInserter::ViralTableInserter(Sexy::MetricsManager*, std::string const&, std::string
   const&, std::string const&) */

void __thiscall
ViralTableInserter::ViralTableInserter
          (ViralTableInserter *this,MetricsManager *param_1,string *param_2,string *param_3,
          string *param_4)

{
  ...
  std::string::string(asStack_18,"ViralEvents");
  ...
  nop();
  ppuVar6 = &PTR__ViralTableInserter_067926b0;
  *(undefined ***)this = &PTR__ViralTableInserter_067926b0;
