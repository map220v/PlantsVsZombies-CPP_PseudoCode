// Class: ActivityCollectionOneYuan


/* ActivityCollectionOneYuan::ActivityCollectionOneYuan() */

void __thiscall
ActivityCollectionOneYuan::ActivityCollectionOneYuan(ActivityCollectionOneYuan *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_06629c30;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_06629f98;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_06629fe0;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionOneYuan_0662a000;
  return;
}
...
/* non-virtual thunk to ActivityCollectionOneYuan::~ActivityCollectionOneYuan() */

void __thiscall
ActivityCollectionOneYuan::~ActivityCollectionOneYuan(ActivityCollectionOneYuan *this)

{
  ~ActivityCollectionOneYuan(this + -0xe8);
  return;
}
...
{
  ~ActivityCollectionOneYuan(this);
  AK::FreeHook(this);
  return;
}
...
/* ActivityCollectionOneYuan::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionOneYuan::InitContainer
          (ActivityCollectionOneYuan *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a07);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_ONEYUAN");
...
/* non-virtual thunk to ActivityCollectionOneYuan::InitContainer(ActivityCollectionTabBase*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionOneYuan::Draw(Sexy::Graphics*) */

void __thiscall ActivityCollectionOneYuan::Draw(ActivityCollectionOneYuan *this,Graphics *param_1)

{
  ...
  pIVar8 = (Image *)CachedUIResourcePtr<Sexy::Image>::operator->
                              ((CachedUIResourcePtr<Sexy::Image> *)&DAT_06aa0408);
  ...
  Sexy::Graphics::DrawImage(param_1,pIVar8,iVar2,iVar4 - iVar3,iVar5,iVar6);
  TodStringTranslate(L"[ONEYUAN_SHOR_DESCRIPTION]");
