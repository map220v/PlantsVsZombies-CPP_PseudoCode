// Class: GameplayTableInserter


/* GameplayTableInserter::~GameplayTableInserter() */

void __thiscall GameplayTableInserter::~GameplayTableInserter(GameplayTableInserter *this)

{
  *(undefined ***)this = &PTR__GameplayTableInserter_067925f0;
...
/* GameplayTableInserter::GameplayTableInserter(Sexy::MetricsManager*, std::string const&,
   std::string const&, std::string const&) */

void __thiscall
GameplayTableInserter::GameplayTableInserter
          (GameplayTableInserter *this,MetricsManager *param_1,string *param_2,string *param_3,
          string *param_4)

{
  ...
  std::string::string(asStack_18,"Gameplay");
  ...
  nop();
  ppuVar6 = &PTR__GameplayTableInserter_067925f0;
  *(undefined ***)this = &PTR__GameplayTableInserter_067925f0;
