// Class: eastl::copy_backward_generic_iterator<false,false>


/* EA::Text::Analysis* eastl::copy_backward_generic_iterator<false,
   false>::do_copy<EA::Text::Analysis*, EA::Text::Analysis*>(EA::Text::Analysis*,
   EA::Text::Analysis*, EA::Text::Analysis*) */

Analysis *
eastl::copy_backward_generic_iterator<false,false>::do_copy<EA::Text::Analysis*,EA::Text::Analysis*>
...
/* unsigned short* eastl::copy_backward_generic_iterator<false, false>::do_copy<unsigned short
   const*, unsigned short*>(unsigned short const*, unsigned short const*, unsigned short*) */

ushort * eastl::copy_backward_generic_iterator<false,false>::
         do_copy<unsigned_short_const*,unsigned_short*>
...
/* EA::Text::AnalysisInfo* eastl::copy_backward_generic_iterator<false,
   false>::do_copy<EA::Text::AnalysisInfo const*, EA::Text::AnalysisInfo*>(EA::Text::AnalysisInfo
   const*, EA::Text::AnalysisInfo const*, EA::Text::AnalysisInfo*) */

AnalysisInfo *
eastl::copy_backward_generic_iterator<false,false>::
...
/* EA::Text::GlyphInfo* eastl::copy_backward_generic_iterator<false,
   false>::do_copy<EA::Text::GlyphInfo const*, EA::Text::GlyphInfo*>(EA::Text::GlyphInfo const*,
   EA::Text::GlyphInfo const*, EA::Text::GlyphInfo*) */
...
/* EA::Text::GlyphLayoutInfo* eastl::copy_backward_generic_iterator<false,
