// Class: ZombiePeaChallenge


/* ZombiePeaChallenge::gameplayEnded() */

void __thiscall ZombiePeaChallenge::gameplayEnded(ZombiePeaChallenge *this)
...
void ZombiePeaChallenge::StaticClassInit(void)

{
  ...
  if ((this != (CRefSymbolDb *)0x0) &&
    ...
    std::string::string(asStack_10,"ZombiePeaChallenge");
    (*pcVar2)(plVar1,asStack_10,FUN_036850f0,0x30,0);
...
/* ZombiePeaChallenge::StaticGetClass() */

long * ZombiePeaChallenge::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"ZombiePeaChallenge",uVar2,StaticNew);
  StaticClassInit();
  return sClass;
}


/* ZombiePeaChallenge::~ZombiePeaChallenge() */

void __thiscall ZombiePeaChallenge::~ZombiePeaChallenge(ZombiePeaChallenge *this)

{
  *(undefined ***)this = &PTR_GetModuleClass_0667b460;
...
/* ZombiePeaChallenge::StaticNew() */

ZombiePeaChallenge * ZombiePeaChallenge::StaticNew(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombiePeaChallenge::onNotifyHitPlant() */

void __thiscall ZombiePeaChallenge::onNotifyHitPlant(ZombiePeaChallenge *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombiePeaChallenge::gameplayStarted() */

void __thiscall ZombiePeaChallenge::gameplayStarted(ZombiePeaChallenge *this)

{
  ...
  Sexy::RtWeakPtr<Sexy::ResourceInfo>::Get((RtWeakPtr<Sexy::ResourceInfo> *)this_00);
  nop();
  CachedUIResourcePtr::operator_cast_to_RtWeakPtr((CachedUIResourcePtr *)&DAT_06aab1d0);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombiePeaChallenge::registerForEvents() */

void __thiscall ZombiePeaChallenge::registerForEvents(ZombiePeaChallenge *this)

{
  ...
  Sexy::
  MakeDelegate<Sexy::AndroidHttpTransaction::ReceivedDataCallback,void(Sexy::AndroidHttpTransaction::ReceivedDataCallback::*)()>
            ((ReceivedDataCallback *)this,onNotifyHitPlant);
  Sexy::Delegate0::Delegate0<ZombiePeaChallenge,void(ZombiePeaChallenge::*)()>
            (aDStack_38,aCStack_50);
  MessageRouter::Subscribe((MessageRouter *)this_00,Message::NotifyHitPlant,aDStack_38);
  if (local_8 == ___stack_chk_guard) {
    return;
  }
                    /* WARNING: Subroutine does not return */
