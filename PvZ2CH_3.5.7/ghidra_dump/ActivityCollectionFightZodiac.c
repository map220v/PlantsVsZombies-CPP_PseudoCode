// Class: ActivityCollectionFightZodiac


/* ActivityCollectionFightZodiac::ActivityCollectionFightZodiac() */

void __thiscall
ActivityCollectionFightZodiac::ActivityCollectionFightZodiac(ActivityCollectionFightZodiac *this)

{
  ActivityCollectionContainerBase::ActivityCollectionContainerBase
            ((ActivityCollectionContainerBase *)this);
  *(undefined ***)this = &PTR_GetClass_0662c570;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_0662c8d8;
  *(undefined ***)(this + 0xe0) = &PTR_InitContainer_0662c920;
  *(undefined ***)(this + 0xe8) = &PTR__ActivityCollectionFightZodiac_0662c940;
  return;
}
...
/* non-virtual thunk to ActivityCollectionFightZodiac::~ActivityCollectionFightZodiac() */

void __thiscall
ActivityCollectionFightZodiac::~ActivityCollectionFightZodiac(ActivityCollectionFightZodiac *this)

{
  ~ActivityCollectionFightZodiac(this + -0xe8);
  return;
}
...
{
  ~ActivityCollectionFightZodiac(this);
  AK::FreeHook(this);
  return;
}
...
/* ActivityCollectionFightZodiac::InitContainer(ActivityCollectionTabBase*) */

void __thiscall
ActivityCollectionFightZodiac::InitContainer
          (ActivityCollectionFightZodiac *this,ActivityCollectionTabBase *param_1)

{
  ...
  FUN_034297a8(this + 0xf8,0x2a45);
  std::string::string(asStack_b8,"IMAGE_UI_ACTIVITYCOLLECTION_BACKGROUND_FIGHTZODIAC");
...
/* non-virtual thunk to ActivityCollectionFightZodiac::InitContainer(ActivityCollectionTabBase*) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActivityCollectionFightZodiac::Draw(Sexy::Graphics*) */

void __thiscall
ActivityCollectionFightZodiac::Draw(ActivityCollectionFightZodiac *this,Graphics *param_1)

{
  ...
  TodStringTranslate(L"[PLANT_FIGHTZODIAC_SHORT_DESCRIPTION]");
