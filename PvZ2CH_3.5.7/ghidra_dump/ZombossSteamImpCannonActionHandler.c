// Class: ZombossSteamImpCannonActionHandler


/* ZombossSteamImpCannonActionHandler::onRocketLaunchFireAnimDone(std::string const&) */

void ZombossSteamImpCannonActionHandler::onRocketLaunchFireAnimDone(string *param_1)
...
/* ZombossSteamImpCannonActionHandler::StaticClassInit() */

void ZombossSteamImpCannonActionHandler::StaticClassInit(void)

{
  ...
  if ((this != (CRefSymbolDb *)0x0) &&
    ...
    std::string::string(asStack_10,"ZombossSteamImpCannonActionHandler");
    (*pcVar2)(plVar1,asStack_10,FUN_03c44560,0x28,0);
...
/* ZombossSteamImpCannonActionHandler::StaticGetClass() */

long * ZombossSteamImpCannonActionHandler::StaticGetClass(void)

{
  ...
  (*pcVar3)(plVar1,"ZombossSteamImpCannonActionHandler",uVar2,StaticNew);
  StaticClassInit();
  return sClass;
}


/* ZombossSteamImpCannonActionHandler::GetClass() const */

long * ZombossSteamImpCannonActionHandler::GetClass(void)
...
/* ZombossSteamImpCannonActionHandler::ZombossSteamImpCannonActionHandler() */

void __thiscall
ZombossSteamImpCannonActionHandler::ZombossSteamImpCannonActionHandler
          (ZombossSteamImpCannonActionHandler *this)

{
  undefined4 uVar1;
  
  ZombieActionHandler::ZombieActionHandler((ZombieActionHandler *)this);
  *(undefined ***)this = &PTR_GetClass_06750c10;
  uVar1 = PVZ_EOT();
...
/* ZombossSteamImpCannonActionHandler::StaticNew() */

ZombossSteamImpCannonActionHandler * ZombossSteamImpCannonActionHandler::StaticNew(void)
...
/* ZombossSteamImpCannonActionHandler::onRocketLaunchAnimDone(std::string const&) */

void ZombossSteamImpCannonActionHandler::onRocketLaunchAnimDone(string *param_1)

{
  ...
  ZombieAnimRig_ZombossMech_Steam::PlayImpCannonLaunchLoop
            ((ZombieAnimRig_ZombossMech_Steam *)this_01);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombossSteamImpCannonActionHandler::onStartAction() */

void __thiscall
ZombossSteamImpCannonActionHandler::onStartAction(ZombossSteamImpCannonActionHandler *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombossSteamImpCannonActionHandler::onRocketStartAnimDone(std::string const&) */

void ZombossSteamImpCannonActionHandler::onRocketStartAnimDone(string *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ZombossSteamImpCannonActionHandler::onUpdateAction() */

void __thiscall
ZombossSteamImpCannonActionHandler::onUpdateAction(ZombossSteamImpCannonActionHandler *this)
