// Class: LevelEditorTowerDefendZombieWaveEditor


/* LevelEditorTowerDefendZombieWaveEditor::LevelEditorTowerDefendZombieWaveEditor() */

void __thiscall
LevelEditorTowerDefendZombieWaveEditor::LevelEditorTowerDefendZombieWaveEditor
          (LevelEditorTowerDefendZombieWaveEditor *this)

{
  LevelEditorZombieWaveEditor::LevelEditorZombieWaveEditor((LevelEditorZombieWaveEditor *)this);
  *(undefined ***)this = &PTR_GetClass_06965a30;
  *(undefined ***)(this + 0xd8) = &PTR_ButtonPress_06965d60;
  return;
}
...
/* LevelEditorTowerDefendZombieWaveEditor::Init() */

void __thiscall
LevelEditorTowerDefendZombieWaveEditor::Init(LevelEditorTowerDefendZombieWaveEditor *this)

{
  ...
  int iVar5;
  Widget *this_00;
  LevelEditorTowerDefendWaveDisplay *this_01;
  PVZ2UIButton *pPVar6;
  int iVar7;
  long *plVar8;
  undefined1 auStack_80 [8];
  wstring awStack_78 [56];
  LevelEditorTowerDefendWaveDisplay *local_40 [7];
  long local_8;
  ...
  do {
    ...
    LevelEditorTowerDefendWaveDisplay::LevelEditorTowerDefendWaveDisplay(this_01);
