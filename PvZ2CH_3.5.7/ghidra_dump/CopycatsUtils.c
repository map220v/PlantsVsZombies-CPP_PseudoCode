...
/* CopycatsUtils::IsPlayingCopycats() */

void CopycatsUtils::IsPlayingCopycats(void)

{
  ...
  local_18 = FUN_04f61708(*(undefined8 *)(lVar2 + 0x88));
  local_10 = FUN_04f61758(*(undefined8 *)(lVar2 + 0x90));
  do {
...
LAB_04f61870:
    ...
    if (bVar1) {
      ...
      bVar1 = Sexy::RtObject::IsA<PVZ1CopycatsModuleProperties>(this);
      if (bVar1) {
