// Class: CornucopiaShopButton


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CornucopiaShopButton::SetItemAmount(int) */

void CornucopiaShopButton::SetItemAmount(int param_1)

{
  ...
  FUN_054766c8((ulong)(uint)param_1 + 0x330,auStack_10);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CornucopiaShopButton::Draw(Sexy::Graphics*) */

void __thiscall CornucopiaShopButton::Draw(CornucopiaShopButton *this,Graphics *param_1)
...
/* CornucopiaShopButton::SetClickCallback(Sexy::Delegate0) */

void __thiscall
CornucopiaShopButton::SetClickCallback(CornucopiaShopButton *this,Delegate2 *param_2)

{
  Sexy::Delegate2<Sexy::IPurchaseDriver*,bool>::operator=
            ((Delegate2<Sexy::IPurchaseDriver*,bool> *)(this + 0x338),param_2);
  return;
}


/* CornucopiaShopButton::~CornucopiaShopButton() */

void __thiscall CornucopiaShopButton::~CornucopiaShopButton(CornucopiaShopButton *this)

{
  *(undefined ***)this = &PTR_GetClass_069e1230;
  *(undefined ***)(this + 0x198) = &PTR__CornucopiaShopButton_069e1590;
  *(undefined ***)(this + 0x300) = &PTR_ButtonPress_069e15b8;
...
/* non-virtual thunk to CornucopiaShopButton::~CornucopiaShopButton() */

void __thiscall CornucopiaShopButton::~CornucopiaShopButton(CornucopiaShopButton *this)

{
  ~CornucopiaShopButton(this + -0x198);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CornucopiaShopButton::InitView() */

void __thiscall CornucopiaShopButton::InitView(CornucopiaShopButton *this)

{
  ...
  iVar3 = FUN_04e56010(6);
  iVar5 = iVar5 + iVar3 * -2;
  iVar4 = FUN_04e56010(3);
  iVar1 = iVar3 * 2 + iVar5;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CornucopiaShopButton::CornucopiaShopButton(int) */

void __thiscall CornucopiaShopButton::CornucopiaShopButton(CornucopiaShopButton *this,int param_1)
...
/* CornucopiaShopButton::BuyConfirm(UIMessageBox*, int) */

void __thiscall
CornucopiaShopButton::BuyConfirm(CornucopiaShopButton *this,UIMessageBox *param_1,int param_2)

{
  ...
  if ((param_2 == 1) &&
     (iVar1 = FUN_04e53f7c(*(undefined8 *)(this + 0x340),*(undefined8 *)(this + 0x350)), iVar1 != 0)
     ) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CornucopiaShopButton::ButtonDepress(int) */

void __thiscall CornucopiaShopButton::ButtonDepress(CornucopiaShopButton *this,int param_1)

{
  ...
  if ((*(int *)(this + 0xd4) == param_1) &&
    ...
    TodStringTranslate(L"[CORNUCOPIA_SHOP_BUY_CONFIRM]");
...
/* non-virtual thunk to CornucopiaShopButton::ButtonDepress(int) */
